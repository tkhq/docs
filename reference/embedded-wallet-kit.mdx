...
description: "Turnkey offers a suite of react components to create embedded wallets without having to setup a backend by using Next.js [server actions](https://nextjs.org/docs/app/building-your-application/data-fetching/server-actions-and-mutations) and associated directives. Each component uses the **authIframeClient** from [@turnkey/sdk-react](https://www.npmjs.com/package/@turnkey/sdk-react)."
---
...
<Frame>
   <img src="/images/reference/img/auth.png" alt="auth" />
</Frame>
...
<Frame>
   <img src="/images/reference/img/export_button.png" alt="export" />
</Frame>

Import

<Frame>
   <img src="/images/reference/img/import_button.png" alt="import" />
</Frame>
...
<Frame>
   <img src="/images/reference/img/auth_with_theme.png" alt="auth with theme" />
</Frame>
