...
The next step is to create another non-root user within the organization with a different API key and exclude it from the root quorum. If you would like to remove a root user from root quorum, you can do this from the Turnkey [dashboard](https://app.turnkey.com/dashboard/users/root-quorum) or [API](https://docs.turnkey.com/api-reference/activities/update-root-quorum).
