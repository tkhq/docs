...
infrastructure — the difference lies in how the wallet behaves onchain, and what additional infrastructure it requires.
...
They're contractless, chain-agnostic, and compatible with any network that supports standard signing curves — no bundlers or onchain
deployment required.
