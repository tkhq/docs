...
Significant latency improvements for all API and SDK flows related to [OAuth](https://docs.turnkey.com/features/oauth).

## 2024-10-29

### Enhanced support for Sei, XLM, TON, DOGE
We now support address derivations for Sei, XLM, TON, and DOGE. See [here](https://docs.turnkey.com/documentation/ecosystem-integrations/) for how we provide chain-level support for ecosystems.
