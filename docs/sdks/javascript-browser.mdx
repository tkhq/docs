...
Creates a passkey for an end-user, handling lower-level configurations for the WebAuthn protocol, including challenges and user details. For more detailed examples using this method [look here](../../solutions/embedded-wallets/code-examples/add-credential).
