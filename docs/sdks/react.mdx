...
<u>Use the sdk-react package when you’re building react based frontend applications that interact with the Turnkey API.</u> 
...
The [`@turnkey/sdk-react`](https://www.npmjs.com/package/@turnkey/sdk-react) package enables developers to use the functionality from the [`@turnkey/sdk-browser`](https://www.npmjs.com/package/@turnkey/sdk-browser) package in react based applications. 
