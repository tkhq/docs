...
This approach is particularly crucial in sensitive flows such as [Email Auth](/features/email-auth), and [Key or Wallet Export](/features/export-wallets), where heightened security is required.
...
read up [Email Auth](/features/email-auth) for more information on the technical details of how it works.
