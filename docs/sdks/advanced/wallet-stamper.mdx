...
<Tabs>
  <TabItem value="npm" label="npm" default>
    <CodeBlock language="bash">{`npm i @turnkey/wallet-stamper`}</CodeBlock>
  </TabItem>
  <TabItem value="pnpm" label="pnpm">
    <CodeBlock language="bash">{`pnpm i @turnkey/wallet-stamper`}</CodeBlock>
  </TabItem>
  <TabItem value="yarn" label="yarn">
    <CodeBlock language="bash">{` yarn add @turnkey/wallet-stamper`}</CodeBlock>
  </TabItem>
</Tabs>
