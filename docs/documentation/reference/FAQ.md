...
Think about Turnkey API keys as an access-gating mechanism to Turnkey functionality. They're flexible in what they can do (you get to decide this with [Policies](/policies/overview)!), and revocable if they are lost or compromised.
