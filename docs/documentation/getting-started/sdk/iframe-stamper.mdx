...
<Tabs>
  <TabItem value="npm" label="npm" default>
    <CodeBlock language="bash">{`npm i @turnkey/iframe-stamper`}</CodeBlock>
  </TabItem>
  <TabItem value="pnpm" label="pnpm">
    <CodeBlock language="bash">{`pnpm i @turnkey/iframe-stamper`}</CodeBlock>
  </TabItem>
  <TabItem value="yarn" label="yarn">
    <CodeBlock language="bash">{`yarn add @turnkey/iframe-stamper`}</CodeBlock>
  </TabItem>
</Tabs>
