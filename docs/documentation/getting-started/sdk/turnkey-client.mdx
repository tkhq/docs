...
You can also implement the TStamper interface yourself. For more information on implementing a custom stamper checkout the [API Design](/api-overview/introduction) docs.
