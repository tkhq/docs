...
The `ApiKeyStamper` class serving as a helper, that implements the `TStamper` interface used by the [TurnkeyClient](./turnkey-client.mdx) in the `@turnkey/http` package.
