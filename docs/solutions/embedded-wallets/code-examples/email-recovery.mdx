...
The email recovery process is split between client-side and server-side operations to ensure security and proper handling of sensitive information.
...
For more information on Next.js server actions, see the
[Next.js documentation on Server Actions and Mutations](https://nextjs.org/docs/app/building-your-application/data-fetching/server-actions-and-mutations).
:::
