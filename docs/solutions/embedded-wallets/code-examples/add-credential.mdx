---
title: "Add a Credential to an Existing Wallet"
sidebar_position: 6
...
This flexibility enables users to add a hardware security device like a YubiKey, a backup passkey, and/or a passkey on a new device,
