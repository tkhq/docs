...
For a deeper architectural walkthrough — including why App Proofs are signed by the enclave's Ephemeral Key rather than the Quorum Key, and the end-to-end verification flow — see [TVC: Proofs and Verification](/features/verifiable-cloud/proofs-and-verification).
