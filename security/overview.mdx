...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  ...
  <FeatureCard title="Remote attestation" icon="check-circle" href="/products/company-wallets/features/security/remote-attestation" description="How Turnkey enclaves cryptographically prove their identity and integrity to a remote verifier." />
