...
<Frame>
  <img src="/images/key-management/encryption-key-escrow-example.png" alt="Encryption escrow flow showing encrypted data in your infrastructure and encryption key in Turnkey secure enclave" />
</Frame>
