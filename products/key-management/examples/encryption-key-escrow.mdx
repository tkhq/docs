...
- **Policy-gated key export:** Use Turnkey's [policy engine](/concepts/policies/overview) to add controls on key export, such as requiring [quorum approval](/concepts/users/root-quorum) for sensitive operations.
...
The Encryption Key Storage pattern enables you to:
