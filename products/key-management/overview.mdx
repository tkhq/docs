...
- Import and export keys with policy controls and quorum approval
...
Store encryption keys in Turnkey that protect API secrets, credentials, or other sensitive configuration. Your infrastructure holds the encrypted secrets; Turnkey holds the decryption key. Access requires authentication through Turnkey's policy engine.
