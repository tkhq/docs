...
| Example | Description |
| :--- | :--- |
| Encrypted Wallet Recovery | Recover wallets and cryptographic material when incidents occur or credentials are compromised |
| [Recovery Key Storage](/products/key-management/examples/encryption-key-escrow) | Use Turnkey as a secure key storage service with a 2-of-2 security model |
