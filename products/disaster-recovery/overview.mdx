...
description: "Secure, auditable recovery paths for wallets and cryptographic material using Turnkey's secure enclaves and quorum policies."
---

> This is a guide to disaster recovery with Turnkey. Our approach provides secure, auditable recovery paths for wallets and cryptographic material, whether migrating from another provider, backing up user wallets, or establishing enterprise-grade treasury recovery procedures.
