...
**Spending limits**: Enforce per-transaction maximums, asset restrictions, or destination restrictions at the policy level.
...
```
 MERCHANTS                          DEPOSIT ADDRESSES (Turnkey wallets)
┌─────────────┐                    ┌─────────────────┐
│ Merchant A  │───────────────────▶│  Deposit Addr A │──┐
└─────────────┘                    └─────────────────┘  │
┌─────────────┐                    ┌─────────────────┐  │
│ Merchant B  │───────────────────▶│  Deposit Addr B │──┤
└─────────────┘                    └─────────────────┘  │
┌─────────────┐                    ┌─────────────────┐  │
│ Merchant C  │───────────────────▶│  Deposit Addr C │──┤
└─────────────┘                    └─────────────────┘  │
                                                        │
                            Sweep service initiates     │
                            transfer to omnibus         │
                                                        ▼
                                   ┌──────────────────────────────────┐
