...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  <FeatureCard title="Delegated Access Overview" icon="log-in-04" href="/concepts/policies/delegated-access-overview" description="Client-side and server-side setup guides" />
  <FeatureCard title="Policy Examples" icon="file-shield-02" href="/concepts/policies/quickstart" description="Ready-to-use templates for EVM, Solana, Bitcoin, and Tron" />
  <FeatureCard title="Transaction Management" icon="switch-horizontal-01" href="/concepts/transaction-management" description="Automate construction, gas sponsorship, and broadcasting" />
  <FeatureCard title="Smart Contract Interfaces" icon="file-code-02" href="/concepts/policies/smart-contract-interfaces" description="Decode ABI parameters for granular function-level policies" />
</div>
