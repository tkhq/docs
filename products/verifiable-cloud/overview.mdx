...
Once the container image details and other customer deployment instructions are received, a QOS manifest is created and has to be cryptographically approved by operator(s) before TVC infrastructure can proceed with the deployment.
