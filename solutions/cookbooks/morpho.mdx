...
The working example can be found [here](https://github.com/tkhq/sdk/tree/main/examples/defi/with-morpho).
...
Here's a simple [script](https://github.com/tkhq/sdk/blob/main/examples/demos/kitchen-sink/src/sdk-server/updateRootQuorum.ts) that shows how to update the root quorum using @turnkey/sdk-server.
