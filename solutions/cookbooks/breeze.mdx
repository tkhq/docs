...
We'll demonstrate this using the [`with-breeze`](https://github.com/tkhq/sdk/tree/main/examples/defi/with-breeze) example, which integrates **Turnkey**, **Solana**, and **Breeze** for staking deposits/withdrawals.
