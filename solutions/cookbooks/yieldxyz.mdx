...
- **Monetization** – ability to layer on additional user-level fees per OAV as well as revenue sharing from validators on all staking integrations
  - _Note: Yield.xyz enforces a minimum 10% fee_
  - _Note: the validator revenue share is applicable only to PVN members (>30 of the largest validator service providers)_
