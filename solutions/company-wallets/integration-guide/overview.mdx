...
<CardGroup cols={2}>
  <Card title="TypeScript" icon="js" iconType="solid" href="/sdks/javascript-server">
    Our most complete SDK. Recommended if your backend can run Node.js.
  </Card>
  <Card title="Go" icon="golang" iconType="solid" href="/sdks/golang">
    Native Go SDK.
  </Card>
  <Card title="Ruby" icon="code" iconType="solid" href="/sdks/ruby">
    turnkey_client gem for Ruby and Rails projects.
  </Card>
  <Card title="Rust" icon="rust" iconType="solid" href="/sdks/rust">
    Native Rust SDK.
  </Card>
  <Card title="Python" icon="python" iconType="solid" href="/sdks/python">
