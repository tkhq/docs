...
See the [examples](https://github.com/tkhq/ruby-sdk/tree/main/examples) folder if you're looking for a complete sample project

## Examples

- [Whoami](https://github.com/tkhq/ruby-sdk/tree/main/examples/whoami): example showcasing API request signing in its simplest form
- [Signing](https://github.com/tkhq/ruby-sdk/tree/main/examples/signing): example showcasing wallet creation and ETH message signing
...
- Update the swagger spec in [`turnkey_client_inputs`](https://github.com/tkhq/ruby-sdk/tree/main/turnkey_client_inputs)
- Bump `gemVersion` in [`config.json`](https://github.com/tkhq/ruby-sdk/blob/main/turnkey_client_inputs/config.json)
- Run `make`
...
If you want to tweak something related to codegen itself, head ([here](https://github.com/tkhq/ruby-sdk/tree/main/turnkey_client_inputs/templates)), make the desired change, and re-generate `turnkey_client`
