...
<Note>
  ...
  initialized. If not, start there first.
</Note>
...
<Tip>
  This lifecycle is further explored in the [Smart Contract Management
  demo](https://github.com/tkhq/solutions/tree/main/smart-contract-mgmt) on
  GitHub.
</Tip>
...
>
  <FeatureCard
    ...
    description="Upload ABIs and Solana IDLs for human-readable, argument-level policy control."
  />
  <FeatureCard
    title="Policy Engine"
    icon="file-shield-02"
  ...
  <SolutionCard
    ...
    description="Build deposit wallets, sweep automations, and treasury flows with the same RBAC model."
  />
  <FeatureCard
    title="EVM Policy Examples"
    icon="file-shield-02"
    href="/features/policies/examples/ethereum"
    description="Ready-made policy patterns for ERC-20 transfers, EIP-712 signing, and more."
  />
</div>
