...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  <FeatureCard title="Smart Contract Interfaces" icon="file-code-02" href="/concepts/policies/smart-contract-interfaces" description="Upload ABIs and Solana IDLs for human-readable, argument-level policy control." />
  ...
  <SolutionCard title="Payment Orchestration" icon="payment-orchestration" href="/company-wallets/code-examples/payment-orchestration" description="Build deposit wallets, sweep automations, and treasury flows with the same RBAC model." />
  <FeatureCard title="EVM Policy Examples" icon="file-shield-02" href="/concepts/policies/examples/ethereum" description="Ready-made policy patterns for ERC-20 transfers, EIP-712 signing, and more." />
</div>
