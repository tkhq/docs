...
<Tip>
  **Building with AI?** Connect your IDE or LLM to Turnkey's docs via our [MCP
  server and LLM feeds](/get-started/using-llms) for contextual help while you
  integrate.
</Tip>
...
>
  <FeatureCard
    ...
    icon="globe-01"
    href="#explore-the-live-demo"
    description="Try a working embedded wallet in your browser. No setup required."
  />
  <FeatureCard
    title="Clone and customize"
    icon="git-branch-01"
    href="#clone-and-customize"
    description="Start from a full demo app and make it your own."
  />
  <FeatureCard
    title="Build with the SDK"
    icon="tool-01"
    href="#build-with-the-integration-guide"
    description="Follow the integration guide to build from your own codebase."
  />
</div>
...
<FeatureCard
  ...
  description="Open wallets.turnkey.com and start exploring."
/>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="react"
    iconType="solid"
    href="/solutions/embedded-wallets/integration-guide/react-native/getting-started"
  >
  ...
  <Card
    ...
    icon="apple"
    iconType="solid"
    href="/solutions/embedded-wallets/integration-guide/swift/getting-started"
  >
  ...
  <Card
    ...
    icon="android"
    iconType="solid"
    href="/solutions/embedded-wallets/integration-guide/kotlin/getting-started"
  >
