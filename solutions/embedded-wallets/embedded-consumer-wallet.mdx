...
| **Session management**       | Allow a user to take multiple, contiguous actions in a defined period of time. Actions include: Read-write or read-only.                                                                              | [Sessions](/features/authentication/sessions/overview)                                                                                                                         |
