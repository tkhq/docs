...
description: "Set up and implement email and SMS OTP authentication using the Turnkey Swift SDK."
...
<FeatureCard title="Passkeys" icon="lock-01" href="/solutions/embedded-wallets/integration-guide/swift/authentication/passkey" description="Learn how to add passkey login and signup to your app." />
