...
<FeatureCard title="Social Logins" icon="lock-01" href="/solutions/embedded-wallets/integration-guide/swift/authentication/social-logins" description="Set up OAuth-based logins (Google, Apple, Discord, X)." />
