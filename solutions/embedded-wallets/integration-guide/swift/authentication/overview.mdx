...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  <FeatureCard title="Email & SMS" icon="lock-01" href="/sdks/swift/authentication/email-sms" description="Set up email and SMS authentication using the Auth Proxy." />
  <FeatureCard title="Passkey Authentication" icon="lock-01" href="/sdks/swift/authentication/passkey" description="Set up passkey authentication with system UI and secure sessions." />
  <FeatureCard title="Social Logins" icon="lock-01" href="/sdks/swift/authentication/social-logins" description="Implement OAuth-based logins (Google, Apple, Discord, X) via Auth Proxy." />
</div>
