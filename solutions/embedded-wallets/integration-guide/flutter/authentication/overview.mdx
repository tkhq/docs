...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  <FeatureCard title="Email & SMS" icon="lock-01" href="/sdks/flutter/authentication/email-sms" description="Set up email and SMS authentication in your Flutter app." />
  <FeatureCard title="Passkey Authentication" icon="lock-01" href="/sdks/flutter/authentication/passkey" description="Set up passkey authentication in your Flutter app." />
  <FeatureCard title="Social Logins" icon="lock-01" href="/sdks/flutter/authentication/social-logins" description="Add social logins (Google, Apple, X, Discord) with wallet creation and account derivation." />
</div>