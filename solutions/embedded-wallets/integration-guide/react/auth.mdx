...
To start, ensure you enable OAuth and check the OAuth providers you want to use in the **Wallet Kit** section of the [Turnkey Dashboard](https://app.turnkey.com). See the [Getting Started](/solutions/embedded-wallets/integration-guide/react/getting-started) guide for more details.
