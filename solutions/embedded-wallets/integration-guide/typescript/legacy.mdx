...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  <FeatureCard title="Auth flow with Passkeys" icon="lock-01" href="/embedded-wallets/code-examples/create-sub-org-passkey" description="Implement an embedded wallet authentication flow with Passkeys." />
  <FeatureCard title="Auth flow with email" icon="lock-01" href="/embedded-wallets/code-examples/authenticate-user-email" description="Implement an embedded wallet authentication flow with email." />
  <FeatureCard title="Signing Transactions" icon="file-code-01" href="/embedded-wallets/code-examples/signing-transactions" description="Sign transactions using Turnkey's embedded wallets." />
</div>
