...
>
  <FeatureCard
    title="Auth flow with Passkeys"
    icon="lock-01"
    href="/solutions/embedded-wallets/integration-guide/react/sub-organization-customization"
    description="Implement an embedded wallet authentication flow with Passkeys."
  />
  <FeatureCard
    title="Auth flow with email"
    icon="lock-01"
    href="/solutions/embedded-wallets/integration-guide/react/auth"
    description="Implement an embedded wallet authentication flow with email."
  />
  <FeatureCard
    title="Signing Transactions"
    icon="file-code-01"
    href="/solutions/embedded-wallets/integration-guide/react/signing"
    description="Sign transactions using Turnkey's embedded wallets."
  />
</div>
