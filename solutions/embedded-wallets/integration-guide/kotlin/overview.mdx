...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  ...
  <FeatureCard title="Authentication" icon="lock-01" href="/solutions/embedded-wallets/integration-guide/kotlin/authentication/overview" description="Set up authentication with Turnkey's Auth Proxy for fast, secure user auth in your Android app." />
