...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  ...
  <SolutionCard title="High Security API Key Storage" icon="encryption-key-storage" href="/solutions/key-management/high-security-api-key-storage" description="Programmatically store and gate access to your most sensitive API keys." />
