...
<Frame>
  <img
    src="/images/key-management/encryption-key-escrow-example.png"
    alt="2-of-2 security model diagram showing encrypted data in your infrastructure and encryption key in Turnkey secure enclave"
  />
</Frame>
...
<Note>
  Explore the complete implementation in the [GitHub encryption-key-escrow
  example](https://github.com/tkhq/sdk/tree/main/examples/encryption-key-escrow).
</Note>
...
>
  <FeatureCard
    ...
    description="How Turnkey protects key material inside hardware-backed enclaves."
  />
  <FeatureCard
    title="Policy Engine"
    icon="file-shield-02"
    href="/features/policies/quickstart"
    description="Define granular access controls and approval requirements for key operations."
  />
  <FeatureCard
    title="Export Private Keys"
    icon="download-01"
    href="/features/wallets/export-wallets"
    description="API documentation for key export flows."
  />
  <SolutionCard
    ...
    description="Import and recover wallets with quorum approval and a cryptographic audit trail."
  />
</div>
