...
This page covers importing external keys into Turnkey ahead of a recovery. To export key material already held by a parent organization to customer-controlled storage, see [Back up parent organization key material](/get-started/parent-organization-backup).
