...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  ...
  <FeatureCard title="Using AI to integrate to Turnkey" icon="cpu-chip-01" href="/developer-reference/using-llms" description="MCP server, docs context, and other ways to use LLMs with Turnkey." />
