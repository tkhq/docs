...
Note: see the [language section](/concepts/policies/language#bitcoin) for more details. For context on bitcoin transaction reinsertion, see the [bitcoin network support](/networks/policies/language#bitcoin) page
