...
```json
{
  "policyName": "Enable Tether TRC-20 transfers on the Nile Testnet for the Tether contract address: "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t"",
  "effect": "EFFECT_ALLOW",
  "condition": "tron.tx.contract[0].contract_address == 'TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t' && tron.tx.contract[0].data[0..8] == 'a9059cbb'"
}
```
