...
| **Eip712TypedData**.    | primaryType              | string                                    | The type of the primary (i.e. outermost) structure in the `message` JSON                                                                                                                                                                                                               |
...
|                                 | verifyingContract       | string (case insensitive)             | The address of the verifying contract                                                                                                                                         |
