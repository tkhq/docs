...
|                         | user_id                  | string                     | The identifier of the user who approved the request                                                                                                                                                                                                                                    |
|                         | type                     | string                     | The credential type, a full list can be found [here](/authentication/credentials#credential-types)                                                                                                                                                             |
|                         | credential_id            | string                     | The credential id of a passkey, this is only populated for passkeys, or authenticators as they're known in the context of Turnkey, not API keys                                                                                                                                        |
...
| **TronContract**       | type                  | string                     | The contract type, a complete list can be found in the [Tron Protocol Documentation](https://github.com/tronprotocol/protocol/blob/2a678934da3992b1a67f975769bbb2d31989451f/core/Tron.proto#L338-L379) |
