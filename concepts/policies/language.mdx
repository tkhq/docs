...
|                    |                                    | `encoding`      | string           | The payload encoding                                                   |
|                    | `ACTIVITY_TYPE_SIGN_TRANSACTION_V2`| `type`          | string           | The transaction type (e.g., `TRANSACTION_TYPE_ETHEREUM, TRANSACTION_TYPE_SOLANA, TRANSACTION_TYPE_BITCOIN, TRANSACTION_TYPE_TRON, TRANSACTION_TYPE_TEMPO`)                                                  |
