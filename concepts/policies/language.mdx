...
For further reference on how Turnkey handles Bitcoin transactions in our policy-enabled transaction signing flow, check out this section in our [Bitcoin Network Support](https://docs.turnkey.com/networks/bitcoin#policy-enabled-bitcoin-transaction-signing) page.
