...
| ----------------------------- | --------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| FEATURE_NAME_EMAIL_AUTH       | Enables email bundle authentication           | Enabled  | Can only be initiated by a parent organization for a sub-organization.                                                                                                                                                                                                     |
| FEATURE_NAME_OTP_EMAIL_AUTH   | Enables email OTP authentication              | Enabled  | Can only be initiated by a parent organization for a sub-organization.                                                                                                                                                                                                     |
