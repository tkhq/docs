...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  <FeatureCard title="Organizations" icon="server-04" href="/concepts/organizations" description="Learn about Organizations on Turnkey." />
  <FeatureCard title="Sub-Organizations" icon="server-04" href="/concepts/sub-organizations" description="Learn about sub-organizations on Turnkey." />
  <FeatureCard title="Users" icon="lock-01" href="/concepts/users/introduction" description="Users, credentials, and root quorum." />
  <FeatureCard title="Wallets" icon="wallet-04" href="/concepts/wallets" description="Learn about Wallets on Turnkey." />
  <FeatureCard title="Resource Limits" icon="file-code-02" href="/concepts/resource-limits" description="Organization resource limits." />
  <FeatureCard title="Policies" icon="file-shield-02" href="/concepts/policies/overview" description="Access controls and policy engine." />
</div>
