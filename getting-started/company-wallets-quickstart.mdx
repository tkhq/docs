...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  <SolutionCard title="Payment Orchestration" icon="payment-orchestration" href="/company-wallets/code-examples/payment-orchestration" description="Build deposit wallets, sweep automations, and treasury flows with policy-enforced access control." />
  <SolutionCard title="Smart Contract Management" icon="smart-contract-management" href="/company-wallets/code-examples/smart-contract-management" description="Secure the full contract lifecycle from deployment to upgrades with granular RBAC." />
  <FeatureCard title="Policies" icon="file-shield-02" href="/concepts/policies/quickstart" description="Define who can sign what with Turnkey's default-deny policy engine." />
