...
<CardGroup cols={2}>
  <Card title="React" icon="react" iconType="solid" href="/sdks/react/getting-started">
    Pre-built components with minimal configuration.
  </Card>
  <Card title="React Native" icon="react" iconType="solid" href="/sdks/react-native/getting-started">
    JavaScript packages for React Native.
  </Card>
  <Card title="Flutter" icon="code" iconType="solid" href="/sdks/flutter/getting-started">
    Dart SDK for Flutter apps.
  </Card>
  <Card title="Swift" icon="apple" iconType="solid" href="/sdks/swift/getting-started">
    Native iOS integration.
  </Card>
  <Card title="Kotlin" icon="android" iconType="solid" href="/sdks/kotlin/getting-started">
