...
- **Dashboard and auth-proxy requests are never subject to IP allowlisting.** You can always use the Dashboard to manage your configuration, even if you misconfigure your rules. Requests signed by your organization's auth-proxy are also exempt.
