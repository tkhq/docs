...
<Frame>
  ![Direct Traffic button on deployment page](/assets/files/tvc_deployment_direct_traffic.png)
</Frame>
...
<Frame>
  ![Delete button on deployment page](/assets/files/tvc_deployment_delete.png)
</Frame>
...
<Frame>
  ![Restore button on deployment page](/assets/files/tvc_deployment_restore.png)
</Frame>
