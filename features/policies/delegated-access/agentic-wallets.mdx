...
2. **Request**: The AI agent sends signing requests using its API key
...
<Note>
  For a working end-to-end implementation, see the [with-agent-wallet example](https://github.com/tkhq/sdk/tree/main/examples/access-control/with-agent-wallet) — it covers wallet creation, agent user setup, policy creation, and a human approval flow.
</Note>
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  <FeatureCard title="Delegated Access Overview" icon="log-in-04" href="/features/policies/delegated-access/overview" description="Client-side and server-side setup guides" />
  <FeatureCard title="Policy Examples" icon="file-shield-02" href="/features/policies/quickstart" description="Ready-to-use templates for EVM, Solana, Bitcoin, and Tron" />
  <FeatureCard title="Transaction Management" icon="switch-horizontal-01" href="/features/transaction-management" description="Automate construction, gas sponsorship, and broadcasting" />
  <FeatureCard title="Smart Contract Interfaces" icon="file-code-02" href="/features/policies/smart-contract-interfaces" description="Decode ABI parameters for granular function-level policies" />
</div>
