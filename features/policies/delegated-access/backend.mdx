...
A simple example demonstrating the server-side delegated access setup can be found [here](https://github.com/tkhq/sdk/tree/main/examples/access-control/with-delegated/server-side).
...
dotenv.config();
  ...
  // To create an API key programmatically check https://github.com/tkhq/sdk/blob/main/examples/demos/kitchen-sink/src/sdk-server/createApiKey.ts
