...
<Frame>
  ![Screen Shot 2023-02-17 at 9.42.29 AM.png](/images/concepts/policies/Screenshot-2026-08-04-at-2.39.21-PM.png)
</Frame>
...
<Frame>
  ![Screen Shot 2023-02-21 at 6.17.11 PM.png](/images/concepts/policies/Screenshot-2026-08-04-at-2.36.30-PM.png)
</Frame>

<Frame>
  ![Screen Shot 2023-02-21 at 6.17.11 PM.png](/images/concepts/policies/Screenshot-2026-08-04-at-2.37.23-PM.png)
</Frame>

UPDATE ME: \>\>\>\> Under access types, select "API key". Enter the user name "Policy Test". This will be an API-only user, and therefore an email is not required. Click continue and create a new API key to associate with the user using the following command:
...
<Frame>
  ![Screen Shot 2023-05-10 at 1.29.00 PM.png](/images/concepts/policies/Screenshot-2026-08-04-at-2.41.26-PM.png)
</Frame>
