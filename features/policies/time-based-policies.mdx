...
allows nor denies, and does not participate in the outcome. Such a policy is reported with the
`OUTCOME_TIME_INACTIVE` policy-evaluation outcome.
...
This policy becomes active at `2026-03-01T00:00:00Z`, becomes inactive at `2026-04-01T00:00:00Z`,
