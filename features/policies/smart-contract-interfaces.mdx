...
_The instructions array is a list of objects, each defining an instruction callable by the program._
...
_The types array defines custom data structures used by the program._
