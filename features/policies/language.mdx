...
inactive key derivation variant evaluate to an empty string or `0`, rather than producing an
evaluation error. Use `SparkKeyDerivation.type` to distinguish variants; `0` is also a valid static
deposit index.
