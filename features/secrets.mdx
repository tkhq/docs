...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  <SolutionCard title="Programmable Credential Manager" icon="encryption-key-storage" href="/solutions/key-management/programmable-credential-manager" description="Policy-gated credential access for humans, services, and AI agents — including multi-agent consensus." />
