...
```json
{
  ...
  "effect": "EFFECT_ALLOW",
  "consensus": "approvers.any(u, u.tags.contains('<PAYMENT_AGENT_TAG_ID>'))",
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  ...
  <SolutionCard title="MPC keyshare and recovery key storage" icon="mpc-keyshare-storage" href="/solutions/key-management/mpc-keyshare-storage" description="Enclave-protected, policy-gated backup and recovery for MPC keyshare bundles and recovery keys." />
