...
- **Recent blockhash**: Turnkey uses the request-level `recentBlockhash` if supplied. Otherwise, it fetches a fresh blockhash during execution. A blockhash inside `unsignedTransaction` alone does not pin the final sponsored blockhash.
