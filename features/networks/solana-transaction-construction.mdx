...
- **Recent blockhash**: Turnkey uses the `recentBlockhash` in the request if supplied, or fetches one during execution. See [Blockhash selection and expiration](/features/networks/solana-transactions#blockhash-selection-and-expiration) for the full rules.
