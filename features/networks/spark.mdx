...
The canonical reference for integrating Turnkey with Spark is [`examples/defi/with-spark`](https://github.com/tkhq/sdk/tree/main/examples/defi/with-spark) in the Turnkey SDK monorepo. It contains:
