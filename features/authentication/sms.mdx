...
SMS pricing is usage-based and varies depending on the country of the destination phone number and the carrier. Prices are shown in U.S. cents per outbound SMS message segment. Taxes/surcharges separate.

Select your country below to view pricing.

To see the full list of supported countries and their associated costs in csv format:[SMS prices](/assets/files/sms-prices.csv)
