...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  <FeatureCard title="Passkey Introduction" icon="lock-01" href="/authentication/passkeys/introduction" description="Biometric and hardware-based passwordless authentication using WebAuthn standard." />
  <FeatureCard title="Email Authentication" icon="lock-01" href="/authentication/email" description="Passwordless login via one-time codes sent to users' email addresses." />
  <FeatureCard title="SMS Authentication" icon="phone-01" href="/authentication/sms" description="User verification through one-time passwords sent via text message." />
  <FeatureCard title="Social Logins" icon="globe-01" href="/authentication/social-logins" description="OAuth authentication with popular social providers like Google, Apple, and Twitter." />
  <FeatureCard title="Sessions" icon="clock" href="/authentication/sessions" description="Manage authenticated user sessions and access tokens in your application." />
</div>
