...
For information about managing authenticated sessions, see our [Sessions](/features/authentication/sessions/overview) documentation.
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  ...
  <FeatureCard title="Sessions" icon="clock" href="/features/authentication/sessions/overview" description="Manage authenticated user sessions and access tokens in your application." />
  <FeatureCard title="MFA" icon="shield-halved" href="/features/authentication/mfa/overview" description="Enforce multi-factor authentication policies for sensitive activities." />
</div>
