...
For transaction versions, signature placeholders, limits, and compute and fee controls, see [Solana transactions](/features/networks/solana-transactions).
The transaction version is separate from the send activity version.
