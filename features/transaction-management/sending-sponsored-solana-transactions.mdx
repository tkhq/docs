...
For additional references leveraging these endpoints, check out our [Swapping Example](/solutions/cookbooks/jupiter) and [Sweeping Example](/cookbook/sweeping).
