...
A stablepair swap is one where both assets carry the `stable` flag in [`list_supported_assets`](api-reference/queries/list-supported-asset). Enterprise rates are negotiable — contact sales for custom pricing.
