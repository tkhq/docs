...
- Your organization is set up with embedded wallets in a [<u>sub-organization model</u>](/features/sub-organizations): Each of your users should map to a dedicated sub-org in Turnkey.
