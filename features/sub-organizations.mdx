...
Sub-organizations are created through the API. There is no way to create one from the Turnkey Dashboard.
...
To delete a sub-organization, you can use the [delete sub-organization activity](/api-reference/activities/delete-sub-organization).
