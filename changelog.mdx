---
title: "Releases"
description: See here for release notes by date.
---
...
Significant latency improvements for all API and SDK flows related to [OAuth](/authentication/social-logins).
</Update>

<Update label="2024-10-29​">
### Enhanced support for Sei, XLM, TON, DOGE​

- We now support address derivations for Sei, XLM, TON, and DOGE. See [here](/ecosystems/framework) for how we provide chain-level support for ecosystems.
...
- You can use the [`sign_transaction` endpoint](/api-reference/signing/sign-transaction) for all Legacy Solana and Solana Versioned transactions.
- For examples on what policies you can write, see [here](/concepts/policies/examples#solana).
...
### [Demo Wallet](https://wallet.tx.xyz/) updates[​](/#demo-wallet-updates "Direct link to demo-wallet-updates")
...
<Update label="2024-09-01​">

### Makes email optional for `ACTIVITY_TYPE_CREATE_READ_WRITE_SESSION`[​](/#makes-email-optional-for-activity_type_create_read_write_session "Direct link to makes-email-optional-for-activity_type_create_read_write_session")
...
<Update label="2024-08-21​">
### Introduces support for OAuth (OIDC 2.0)​

Our [OAuth](/authentication/social-logins) feature is now live and out of beta. This introduces the following functionalities:
