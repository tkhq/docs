...
A downloadable price list for all supported
countries is available <a href="/assets/files/sms-prices.csv" id="sms-price-download-link" download="sms-pricing.csv">here as a CSV</a>.
