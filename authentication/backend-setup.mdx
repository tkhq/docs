...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  <FeatureCard title="Co-signing Transactions" icon="file-code-01" href="/company-wallets/co-signing-transactions" description="Learn about advanced patterns like multi-signature setups requiring approvals from both the user and the backend." />
</div>
