...
<Frame>
  <img src="/images/passkeys/img/passkeys/timeout.png" alt="Timeout popup" />
</Frame>
...
<Frame>
  <img src="/images/passkeys/img/passkeys/registration_options_rpid.png" alt="RPID in registration prompt" />
</Frame>
...
<Frame>
  <img src="/images/passkeys/img/passkeys/user_name_and_display.png" alt="User name and display name in passkey list" />
</Frame>
...
| <Frame> <img src="/images/passkeys/img/passkeys/attachment_unspecified.png" alt="authenticatorAttachment unspecified" />    </Frame>                             | <Frame> <img src="/images/passkeys/img/passkeys/attachment_platform.png" alt="authenticatorAttachment set to platform" />    </Frame> | <Frame> <img src="/images/passkeys/img/passkeys/attachment_cross_platform.png" alt="authenticatorAttachment set to cross-platform" /> </Frame> |
...
| -------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| <Frame> <img src="/images/passkeys/img/passkeys/transport_internal.png" alt="authentication prompt with transports: internal" /> </Frame> | <Frame> <img src="/images/passkeys/img/passkeys/transport_usb.png" alt="authentication prompt with transports: usb" /> </Frame> | <Frame> <img src="/images/passkeys/img/passkeys/transport_hybrid.png" alt="authentication prompt with transport: hybrid" /> </Frame> |
...
<Frame>
  <img src="/images/passkeys/img/passkeys/no_passkey_available.png" alt="Chrome error when no matching passkey has been found for the provided Credential ID" />
</Frame>
...
<Frame>
  <img src="/images/passkeys/img/passkeys/wrong_credential_id.png" alt="Chrome error when the credential ID used by the user is not in the allowCredentials list" />
</Frame>
