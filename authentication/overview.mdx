...
For information about managing authenticated sessions, see our [Sessions](/authentication/sessions/overview) documentation.
...
<CardGroup cols={2}>
  ...
  <Card title="Sessions" icon="clock" href="/authentication/sessions/overview">
    Manage authenticated user sessions and access tokens in your application.
  </Card>
  <Card title="MFA" icon="shield-halved" href="/authentication/mfa">
    Enforce multi-factor authentication policies for sensitive activities.
  </Card>
</CardGroup>
