...
<CardGroup cols={2}>
  <Card title="API Key Stamper" icon="github" iconType="solid" horizontal href="https://github.com/tkhq/sdk/blob/main/packages/api-key-stamper">
    
  </Card>
  <Card title="WebAuthn Stamper" icon="github" iconType="solid" horizontal href="https://github.com/tkhq/sdk/blob/main/packages/webauthn-stamper">
    
  </Card>
  <Card title="React Native Stamper" icon="github" iconType="solid" horizontal href="https://github.com/tkhq/sdk/tree/main/packages/react-native-passkey-stamper">
    
  </Card>
  <Card title="iFrame Stamper" icon="github" iconType="solid" horizontal href="https://github.com/tkhq/sdk/tree/main/packages/iframe-stamper">
    
  </Card>
  <Card title="Telegram Cloud Storage Stamper" icon="github" iconType="solid" horizontal href="https://github.com/tkhq/sdk/tree/main/packages/telegram-cloud-storage-stamper">
    
  </Card>
  <Card title="IndexedDb Stamper" icon="github" iconType="solid" horizontal href="https://github.com/tkhq/sdk/tree/main/packages/indexed-db-stamper">
    
  </Card>
  <Card title="CLI" icon="github" iconType="solid" horizontal href="https://github.com/tkhq/tkcli/blob/main/src/cmd/turnkey/pkg/request.go">
    
  </Card>
  <Card title="Wallet Stamper" icon="github" iconType="solid" horizontal href="https://github.com/tkhq/sdk/tree/main/packages/wallet-stamper">
