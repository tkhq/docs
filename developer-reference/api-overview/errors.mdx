---
title: "Errors"
description: "Error codes, messages, and troubleshooting guide for the Turnkey API."
---
...
<Note> Not all errors currently include a `turnkeyErrorCode`, though we aim to include one in all customer-facing errors. If you encounter an error where you would expect a `turnkeyErrorCode` but don't see one, please contact Turnkey support.</Note>
...
| InvalidArgument   | 400       | [auth_code must be set](#oauth2-parameter-errors)                                                                                                                                                                                                                                                                                                       |
| InvalidArgument   | 400       | [code_verifier must be set](#oauth2-parameter-errors)                                                                                                                                                                                                                                                                                                   |
| InvalidArgument   | 400       | [oauth2_credential_id must be set](#oauth2-parameter-errors)                                                                                                                                                                                                                                                                                            |
| InvalidArgument   | 400       | [redirect_uri must be set](#oauth2-parameter-errors)                                                                                                                                                                                                                                                                                                    |
| InvalidArgument   | 400       | [client_id must be set](#oauth2-parameter-errors)                                                                                                                                                                                                                                                                                                       |
