...
<NestedParam parentKey="activities.intent" childKey="approveTvcDeploymentIntent" type="object" required={false}>
      approveTvcDeploymentIntent field
      <Expandable title="approveTvcDeploymentIntent details">
        <NestedParam parentKey="activities.intent.approveTvcDeploymentIntent" childKey="deploymentId" type="string" required={true}>
...
<NestedParam parentKey="activities.result" childKey="approveTvcDeploymentResult" type="object" required={false}>
      approveTvcDeploymentResult field
      <Expandable title="approveTvcDeploymentResult details">
        <NestedParam parentKey="activities.result.approveTvcDeploymentResult" childKey="deploymentId" type="string" required={true}>
