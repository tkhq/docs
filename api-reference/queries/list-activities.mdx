...
<NestedParam parentKey="activities.intent.upsertSwapConfigIntent" childKey="provider" type="string" required={false}>
provider field
</NestedParam>
...
<NestedParam parentKey="activities.result" childKey="executeSwapResult" type="object" required={false}>
      ...
      <Expandable title="executeSwapResult details">
        <NestedParam parentKey="activities.result.executeSwapResult" childKey="sendTransactionStatusId" type="string" required={true}>
