...
<NestedParam parentKey="activities.intent.createVelocityControlIntent.dataSource.chainAssetTransfer.definition" childKey="decimals" type="string" required={true}>
...
<NestedParam parentKey="activities.intent.createVelocityControlIntent.aggregation" childKey="window" type="object" required={true}>
      ...
      <Expandable title="rolling details">
        <NestedParam parentKey="activities.intent.createVelocityControlIntent.aggregation.window.rolling" childKey="duration" type="string" required={true}>
