...
<NestedParam parentKey="activity.intent.otpAuthIntent" childKey="targetPublicKey" type="string" required={false}>
...
curl --request POST \
  ...
  --data '{
    ...
    "timestampMs": "<string> (e.g., 1745002503360)",
...
```json 200
{
  "activity": {
    ...
    "timestampMs": "<timestamp> (e.g., 1745002503361)",
    "result": {
      "activity": {
        "id": "<string>",
