...
Enum options: `TRANSACTION_TYPE_ETHEREUM`, `TRANSACTION_TYPE_SOLANA`, `TRANSACTION_TYPE_TRON`, `TRANSACTION_TYPE_BITCOIN`
...
<NestedParam parentKey="activity.intent" childKey="approveTvcDeploymentIntent" type="object" required={false}>
      approveTvcDeploymentIntent field
      <Expandable title="approveTvcDeploymentIntent details">
        <NestedParam parentKey="activity.intent.approveTvcDeploymentIntent" childKey="deploymentId" type="string" required={true}>
...
<NestedParam parentKey="activity.result" childKey="approveTvcDeploymentResult" type="object" required={false}>
      approveTvcDeploymentResult field
      <Expandable title="approveTvcDeploymentResult details">
        <NestedParam parentKey="activity.result.approveTvcDeploymentResult" childKey="deploymentId" type="string" required={true}>
