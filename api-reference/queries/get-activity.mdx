...
<NestedParam
  parentKey="activity.intent.createOrganizationIntent.rootAuthenticator"
  childKey="challenge"
  type="string"
  required={true}
>
...
<NestedParam
  parentKey="activity.intent.createOrganizationIntent"
  childKey="rootUserId"
  type="string"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.createAuthenticatorsIntent.authenticators"
  childKey="challenge"
  type="string"
  required={true}
>
...
<NestedParam
  parentKey="activity.intent.createAuthenticatorsIntent"
  childKey="userId"
  type="string"
  required={true}
>
...
<NestedParam
  parentKey="activity.intent.createUsersIntent.users.authenticators"
  childKey="challenge"
  type="string"
  required={true}
>
...
<NestedParam
  parentKey="activity.intent.acceptInvitationIntent.authenticator"
  childKey="challenge"
  type="string"
  required={true}
>
...
<NestedParam
  parentKey="activity.intent.createApiKeysIntent"
  childKey="userId"
  type="string"
  required={true}
>
...
<NestedParam
  parentKey="activity.intent.createAuthenticatorsIntentV2"
  childKey="userId"
  type="string"
  required={true}
>
...
<NestedParam
  parentKey="activity.intent.createOrganizationIntentV2"
  childKey="rootUserId"
  type="string"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.createSubOrganizationIntentV2"
  childKey="rootQuorumThreshold"
  type="number"
  required={true}
>
  The threshold of unique approvals to reach root quorum. This value must be
  less than or equal to the number of root users
</NestedParam>
...
<NestedParam
  parentKey="activity.intent.updateUserIntent"
  childKey="userPhoneNumber"
  type="string"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.createWalletIntent"
  childKey="mnemonicLength"
  type="number"
  required={false}
>
  Length of mnemonic to generate the Wallet seed. Defaults to 12. Accepted
...
<NestedParam
  parentKey="activity.intent.createWalletAccountsIntent"
  childKey="persist"
  type="boolean"
  required={false}
>
  Indicates if the wallet accounts should be persisted. This is helpful if you'd
  like to see the addresses of different derivation paths without actually
  creating the accounts. Defaults to true.
</NestedParam>
...
<NestedParam
  parentKey="activity.intent.initUserEmailRecoveryIntent"
  childKey="sendFromEmailAddress"
  type="string"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.initUserEmailRecoveryIntent"
  childKey="sendFromEmailSenderName"
  type="string"
  required={false}
>
  Optional custom sender name for use with sendFromEmailAddress; if left empty,
  will default to 'Notifications'
</NestedParam>
<NestedParam
  parentKey="activity.intent.initUserEmailRecoveryIntent"
  childKey="replyToEmailAddress"
  type="string"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.recoverUserIntent"
  childKey="userId"
  type="string"
  required={true}
>
...
<NestedParam
  parentKey="activity.intent.createSubOrganizationIntentV4.wallet"
  childKey="mnemonicLength"
  type="number"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.createSubOrganizationIntentV4"
  childKey="disableEmailRecovery"
  type="boolean"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.emailAuthIntent"
...
<NestedParam
  parentKey="activity.intent.createSubOrganizationIntentV5.wallet"
  childKey="mnemonicLength"
  type="number"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.createSubOrganizationIntentV5"
  childKey="disableEmailRecovery"
  type="boolean"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.createApiKeysIntentV2"
  childKey="userId"
  type="string"
  required={true}
>
...
<NestedParam
  parentKey="activity.intent.emailAuthIntentV2"
  childKey="invalidateExisting"
  type="boolean"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.createSubOrganizationIntentV6.wallet"
  childKey="mnemonicLength"
  type="number"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.createSubOrganizationIntentV6"
  childKey="disableEmailRecovery"
  type="boolean"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.deletePrivateKeysIntent"
  childKey="deleteWithoutExport"
  type="boolean"
  required={false}
>
  Optional parameter for deleting the private keys, even if any have not been
  previously exported. If they have been exported, this field is ignored.
</NestedParam>
...
<NestedParam
  parentKey="activity.intent.deleteWalletsIntent"
  childKey="deleteWithoutExport"
  type="boolean"
  required={false}
>
  Optional parameter for deleting the wallets, even if any have not been
  previously exported. If they have been exported, this field is ignored.
</NestedParam>
...
<NestedParam
  parentKey="activity.intent.initOtpAuthIntent"
  childKey="userIdentifier"
  type="string"
  required={false}
>
  Optional client-generated user identifier to enable per-user rate limiting for
  SMS auth. We recommend using a hash of the client-side IP address.
</NestedParam>
<NestedParam
  parentKey="activity.intent.initOtpAuthIntent"
  childKey="sendFromEmailAddress"
...
<NestedParam
  parentKey="activity.intent.createSubOrganizationIntentV7.wallet"
  childKey="mnemonicLength"
  type="number"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.initOtpAuthIntentV2"
  childKey="userIdentifier"
  type="string"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.initOtpAuthIntentV2"
  childKey="alphanumeric"
  type="boolean"
  required={false}
>
  Optional flag to specify if the OTP code should be alphanumeric (Crockford’s
  Base32). Default = true
</NestedParam>
<NestedParam
  parentKey="activity.intent.initOtpAuthIntentV2"
...
<NestedParam
  parentKey="activity.intent.initOtpIntent"
  childKey="userIdentifier"
  type="string"
  required={false}
>
...
<NestedParam
  ...
  required={false}
>
  Expiration window (in seconds) indicating how long the OTP is valid for. If
  not provided, a default of 5 minutes will be used. Maximum value is 600
  seconds (10 minutes)
</NestedParam>
<NestedParam
  parentKey="activity.intent.initOtpIntent"
...
<NestedParam
  parentKey="activity.intent.updateAuthProxyConfigIntent.walletKitSettings"
  childKey="oauthClientIds"
  type="object"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.deleteWalletAccountsIntent"
  childKey="deleteWithoutExport"
  type="boolean"
  required={false}
>
  Optional parameter for deleting the wallet accounts, even if any have not been
  previously exported. If they have been exported, this field is ignored.
</NestedParam>
...
<NestedParam
  parentKey="activity.intent.emailAuthIntentV3"
  childKey="invalidateExisting"
  type="boolean"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.initUserEmailRecoveryIntentV2"
  childKey="sendFromEmailAddress"
  type="string"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.initOtpIntentV2"
  childKey="userIdentifier"
  type="string"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.initOtpAuthIntentV3"
  childKey="userIdentifier"
  type="string"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.createTvcAppIntent.manifestSetParams"
  childKey="threshold"
  type="number"
  required={true}
>
...
<NestedParam
  parentKey="activity.intent.createTvcAppIntent.shareSetParams"
  childKey="threshold"
  type="number"
  required={true}
>
...
<NestedParam
  parentKey="activity.intent.createTvcAppIntent"
  childKey="enableEgress"
  type="boolean"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.initOtpIntentV3"
  childKey="userIdentifier"
  type="string"
  required={false}
>
...
>
  Optional flag to specify if the OTP code should be alphanumeric (Crockford’s
  Base32). If set to false, OTP code will only be numeric. Default = true
</NestedParam>
<NestedParam
  parentKey="activity.intent.initOtpIntentV3"
  childKey="sendFromEmailSenderName"
...
<NestedParam
  parentKey="activity.intent.otpLoginIntentV2"
  childKey="expirationSeconds"
  type="string"
  required={false}
>
  Expiration window (in seconds) indicating how long the Session is valid for.
...
<NestedParam
  parentKey="activity.intent.createSubOrganizationIntentV8.wallet"
  childKey="mnemonicLength"
  type="number"
  required={false}
>
...
<NestedParam
  parentKey="activity.intent.setIpAllowlistIntent"
  childKey="onEvaluationError"
  type="string"
  required={false}
>
  Behavior when an error occurs during IP allowlist evaluation. Valid values:
  ALLOW, DENY. Defaults to DENY.
</NestedParam>
...
<NestedParam
  parentKey="activity.intent.sparkSignFrostIntent.signatures.derivation"
...
<NestedParam
  parentKey="activity.intent.sparkSignFrostIntent.signatures"
  childKey="adaptorPublicKey"
  type="string"
  required={false}
>
  Optional adaptor point T (hex-encoded 33-byte compressed secp256k1 pubkey).
  When set, Turnkey produces a Schnorr adaptor pre-signature with the FROST
  challenge bound to `R+T` (where `R` is the aggregate group nonce commitment
  from FROST). The party holding the discrete log `t` completes the pre-sig to a
  valid BIP-340 signature by adding `t` (or `-t`, for parity) to the signature
  scalar `s`. This is primarily used by Spark leaves-swap and other
  adaptor-bound flows; absent or empty leads to plain FROST signing (the typical
  case).
</NestedParam>
...
<NestedParam
  parentKey="activity.intent.sparkClaimTransferIntent.claim"
  childKey="transferId"
  type="string"
  required={true}
>
  Spark transfer identifier (UUID). Used together with each leaf's
  sender_signature to verify the sender bound this ciphertext to this transfer.
</NestedParam>
<NestedParam
  parentKey="activity.intent.sparkClaimTransferIntent.claim"
  childKey="senderIdentityPublicKey"
  type="string"
  required={true}
>
  Sender's compressed secp256k1 identity public key (hex-encoded, 33 bytes).
  Used to verify the per-leaf sender_signature fields.
</NestedParam>
...
<NestedParam
  parentKey="activity.result.createTvcAppResult"
  childKey="manifestSetThreshold"
  type="number"
  required={true}
>
...
<NestedParam
  parentKey="activity.result.sparkPrepareLightningReceiveResult"
  childKey="paymentHash"
  type="string"
  required={true}
>
...
<NestedParam
  parentKey="activity.votes.user.apiKeys"
  childKey="expirationSeconds"
  type="string"
  required={false}
>
        ...
        "rootAuthenticator": {
          ...
          "attestation": {
            ...
            "response": {
              ...
              "transports": ["<AUTHENTICATOR_TRANSPORT_BLE>"],
              "authenticatorAttachment": "<cross-platform>"
            },
