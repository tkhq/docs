...
<NestedParam parentKey="activity.intent.upsertSwapConfigIntent" childKey="provider" type="string" required={false}>
provider field
</NestedParam>
...
<NestedParam parentKey="activity.result" childKey="executeSwapResult" type="object" required={false}>
      ...
      <Expandable title="executeSwapResult details">
        <NestedParam parentKey="activity.result.executeSwapResult" childKey="sendTransactionStatusId" type="string" required={true}>
