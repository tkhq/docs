---
title: "Queries"
description: "Queries are read requests to Turnkey's API. They allow you to retrieve data about your organization and its resources. Learn more in the [Queries API Reference](/api-reference/queries)."
...
For a full list of available queries and their parameters, see the [Queries API Reference](/api-reference/queries).
