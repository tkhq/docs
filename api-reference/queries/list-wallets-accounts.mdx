...
<ParamField
  ...
  type="object"
  required={false}
  path="paginationOptions"
>
  <p>paginationOptions field</p>
  <Expandable title="details">
    <NestedParam
      parentKey="paginationOptions"
      childKey="limit"
      type="string"
      required={false}
      default=""
    ...
    <NestedParam
      ...
      default=""
    >
      A pagination cursor. This is an object ID that enables you to fetch all
      objects before this ID.
    </NestedParam>
...
<NestedParam
  parentKey="accounts.walletDetails"
  childKey="exported"
  type="boolean"
  required={true}
>
