    ...
    >
      ...
      <Expandable title="details">
        <ParamField
          ...
          type="array"
          required={true}
          path="parameters.claim.leaves"
        >
          <p>Leaves being claimed.</p>
          <Expandable title="item details">
            <NestedParam
              parentKey="parameters.claim.leaves"
              childKey="leafId"
              type="string"
              required={true}
              default=""
            ...
            <NestedParam
              ...
              default=""
            >
              ECIES ciphertext (hex-encoded) containing the inbound transfer
              secret. Decrypted inside the enclave using the wallet's Identity
              key.
            </NestedParam>

            <NestedParam
              parentKey="parameters.claim.leaves"
              childKey="senderSignature"
              type="string"
              required={true}
              default=""
            >
              Hex-encoded 64-byte compact ECDSA signature binding (leaf_id,
              transfer_id, ciphertext) to the sender's identity key. Verified
              inside the enclave before decryption.
            </NestedParam>
          </Expandable>
        </ParamField>
        <NestedParam
          parentKey="parameters.claim"
          childKey="threshold"
          type="number"
          required={true}
          default=""
        ...
        <ParamField
          ...
          type="array"
          required={true}
          path="parameters.claim.operatorRecipients"
        >
          <p>Operators that will receive Shamir shares.</p>
          <Expandable title="item details">
            <NestedParam
              parentKey="parameters.claim.operatorRecipients"
              childKey="operatorId"
              type="string"
              required={true}
              default=""
        ...
        >
          ...
          sender_signature to verify the sender bound this ciphertext to this
          transfer.
        </NestedParam>
        ...
        <NestedParam
          ...
          default=""
        >
          Sender's compressed secp256k1 identity public key (hex-encoded, 33
          bytes). Used to verify the per-leaf sender_signature fields.
        </NestedParam>
      </Expandable>
    </ParamField>
  </Expandable>
