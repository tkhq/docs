---
title: "Delete a TVC App and all of its deployments"
...
<EndpointPath type="submit" path="delete_tvc_app_and_deployments" />
...
<NestedParam parentKey="activity" childKey="intent" type="object" required={true}>
      ...
      <Expandable title="intent details">
        <NestedParam parentKey="activity.intent" childKey="deleteTvcAppAndDeploymentsIntent" type="object" required={true}>
...
<NestedParam parentKey="activity" childKey="result" type="object" required={true}>
      ...
      <Expandable title="result details">
        <NestedParam parentKey="activity.result" childKey="deleteTvcAppAndDeploymentsResult" type="object" required={true}>
...
const response = await turnkeyClient.apiClient().deleteTvcAppAndDeployments({
  appId: "<string> (The unique identifier of the TVC app to delete. The app and all associated deployments will be removed.)"
});
```
