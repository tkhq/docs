---
title: "Update an OAuth 2.0 Credential"
...
<EndpointPath type="submit" path="update_oauth2_credential" />
...
<NestedParam parentKey="activity" childKey="intent" type="object" required={true}>
      ...
      <Expandable title="intent details">
        <NestedParam parentKey="activity.intent" childKey="updateOauth2CredentialIntent" type="object" required={true}>
...
<NestedParam parentKey="activity" childKey="result" type="object" required={true}>
      ...
      <Expandable title="result details">
        <NestedParam parentKey="activity.result" childKey="updateOauth2CredentialResult" type="object" required={true}>
...
const response = await turnkeyClient.apiClient().updateOauth2Credential({
  oauth2CredentialId: "<string> (The ID of the OAuth 2.0 credential to update)",
