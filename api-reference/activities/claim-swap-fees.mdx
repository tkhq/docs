...
<EndpointPath type="submit" path="claim_swap_fees" />
...
Enum options: `ACTIVITY_TYPE_CLAIM_SWAP_FEES`
</ParamField>
...
<NestedParam parentKey="activity" childKey="intent" type="object" required={true}>
      ...
      <Expandable title="intent details">
        <NestedParam parentKey="activity.intent" childKey="claimSwapFeesIntent" type="object" required={true}>
The claimSwapFeesIntent object
</NestedParam>
...
<NestedParam parentKey="activity" childKey="result" type="object" required={true}>
      ...
      <Expandable title="result details">
        <NestedParam parentKey="activity.result" childKey="claimSwapFeesResult" type="object" required={true}>
      The claimSwapFeesResult object
...
```bash title="cURL"
curl --request POST \
  --url https://api.turnkey.com/public/v1/submit/claim_swap_fees \
...
const response = await turnkeyClient.apiClient().claimSwapFees({});
```
