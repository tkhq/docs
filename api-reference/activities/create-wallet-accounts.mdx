  ...
  <Expandable title="details">
    ...
    <ParamField body="accounts" type="array" required={true} path="parameters.accounts">
      ...
      <Expandable title="item details">
        ...
        <NestedParam parentKey="parameters.accounts" childKey="name" type="string" required={false} default="">
        Optional human-readable name for the account.
        </NestedParam>
      </Expandable>
    </ParamField>
    <NestedParam parentKey="parameters" childKey="persist" type="boolean" required={false} default="">
