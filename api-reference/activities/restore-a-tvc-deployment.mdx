---
title: "Restore a TVC Deployment"
...
<EndpointPath type="submit" path="restore_tvc_deployment" />
...
<NestedParam parentKey="activity" childKey="intent" type="object" required={true}>
      ...
      <Expandable title="intent details">
        <NestedParam parentKey="activity.intent" childKey="restoreTvcDeploymentIntent" type="object" required={true}>
...
<NestedParam parentKey="activity" childKey="result" type="object" required={true}>
      ...
      <Expandable title="result details">
        <NestedParam parentKey="activity.result" childKey="restoreTvcDeploymentResult" type="object" required={true}>
...
const response = await turnkeyClient.apiClient().restoreTvcDeployment({
  deploymentId: "<string> (The unique identifier of the TVC deployment to restore.)"
});
```
