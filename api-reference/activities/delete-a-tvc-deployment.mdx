...
<EndpointPath type="submit" path="delete_tvc_deployment" />
...
<NestedParam parentKey="activity" childKey="intent" type="object" required={true}>
      ...
      <Expandable title="intent details">
        <NestedParam parentKey="activity.intent" childKey="deleteTvcDeploymentIntent" type="object" required={true}>
...
<NestedParam parentKey="activity" childKey="result" type="object" required={true}>
      ...
      <Expandable title="result details">
        <NestedParam parentKey="activity.result" childKey="deleteTvcDeploymentResult" type="object" required={true}>
...
const response = await turnkeyClient.apiClient().deleteTvcDeployment({
  deploymentId: "<string> (The unique identifier of the TVC deployment to delete.)"
});
```
