...
<EndpointPath type="submit" path="delete_velocity_control" />
...
Enum options: `ACTIVITY_TYPE_DELETE_VELOCITY_CONTROL`
</ParamField>
...
<ParamField body="parameters" type="object" required={true} path="parameters">
  ...
  <Expandable title="details">
    <NestedParam parentKey="parameters" childKey="velocityControlId" type="string" required={true} default="">
...
<NestedParam parentKey="activity" childKey="intent" type="object" required={true}>
      ...
      <Expandable title="intent details">
        <NestedParam parentKey="activity.intent" childKey="deleteVelocityControlIntent" type="object" required={true}>
      The deleteVelocityControlIntent object
...
<NestedParam parentKey="activity" childKey="result" type="object" required={true}>
      ...
      <Expandable title="result details">
        <NestedParam parentKey="activity.result" childKey="deleteVelocityControlResult" type="object" required={true}>
      The deleteVelocityControlResult object
...
```bash title="cURL"
curl --request POST \
  --url https://api.turnkey.com/public/v1/submit/delete_velocity_control \
...
const response = await turnkeyClient.apiClient().deleteVelocityControl({
