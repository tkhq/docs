...
<Warning>
  This activity is deprecated. Use the specific update activities instead: [Update User's Email](/api-reference/activities/update-users-email), [Update User's Name](/api-reference/activities/update-users-name), or [Update User's Phone Number](/api-reference/activities/update-users-phone-number).
</Warning>
