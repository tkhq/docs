...
<NestedParam parentKey="activity" childKey="intent" type="object" required={true}>
      ...
      <Expandable title="intent details">
        <NestedParam parentKey="activity.intent" childKey="initOtpIntentV3" type="object" required={true}>
...
<NestedParam parentKey="activity" childKey="result" type="object" required={true}>
      ...
      <Expandable title="result details">
        <NestedParam parentKey="activity.result" childKey="initOtpResultV2" type="object" required={true}>
...
const response = await turnkeyClient.apiClient().initOtp({
  otpType: "<string> (Whether to send OTP via SMS, email, or WhatsApp. Possible values: OTP_TYPE_SMS, OTP_TYPE_EMAIL, OTP_TYPE_WHATSAPP)",
