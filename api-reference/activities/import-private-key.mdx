...
<ParamField body="parameters" type="object" required={true} path="parameters">
  ...
  <Expandable title="details">
    ...
    <NestedParam parentPath="parameters" body="privateKeyName" type="string" required={true} default="">
    ...
    <NestedParam parentPath="parameters" body="curve" type="enum<string>" required={true} default="">
    
    Enum options: `CURVE_SECP256K1`, `CURVE_ED25519`
    </NestedParam>
    
    <NestedParam parentPath="parameters" body="addressFormats" type="enum<string[]>" required={true} default="">
