...
<ParamField body="parameters" type="object" required={true} path="parameters">
  ...
  <Expandable title="details">
    <NestedParam parentPath="parameters" body="privateKeyTagId" type="string" required={true} default="">
    
    Unique identifier for a given Private Key Tag.
    </NestedParam>
    
    <NestedParam parentPath="parameters" body="newPrivateKeyTagName" type="string" required={false} default="">
