  ...
  <Expandable title="details">
    ...
    <ParamField body="oauthProviders" type="array" required={true} path="parameters.oauthProviders">
      ...
      <Expandable title="item details">
        <NestedParam parentPath="parameters.oauthProviders" body="providerName" type="string" required={true} default="">
        
        Human-readable name to identify a Provider.
        </NestedParam>
        
        <NestedParam parentPath="parameters.oauthProviders" body="oidcToken" type="string" required={true} default="">
