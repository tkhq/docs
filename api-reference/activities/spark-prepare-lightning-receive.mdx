...
<ParamField body="parameters" type="object" required={true} path="parameters">
  ...
  <Expandable title="details">
    ...
    <ParamField
      body="lightningReceive"
      type="object"
      required={true}
      path="parameters.lightningReceive"
    >
      <p>lightningReceive field</p>
      <Expandable title="details">
        <NestedParam
          parentKey="parameters.lightningReceive"
          childKey="threshold"
          type="number"
          required={true}
          default=""
        ...
        <ParamField
          ...
          type="array"
          required={true}
          path="parameters.lightningReceive.operatorRecipients"
        >
          <p>
            Operators that will receive Feldman shares of the preimage. Order
            must match the operators' numeric IDs in the Spark operator config -
            share index is the 1-based position in this list.
          </p>
          <Expandable title="item details">
            <NestedParam
              parentKey="parameters.lightningReceive.operatorRecipients"
              childKey="operatorId"
              type="string"
              required={true}
              default=""
