...
<EndpointPath type="submit" path="claim_earn_fees" />
...
Enum options: `ACTIVITY_TYPE_CLAIM_EARN_FEES`
</ParamField>
...
<NestedParam parentKey="activity" childKey="intent" type="object" required={true}>
      ...
      <Expandable title="intent details">
        <NestedParam parentKey="activity.intent" childKey="claimEarnFeesIntent" type="object" required={true}>
      The claimEarnFeesIntent object
...
<NestedParam parentKey="activity" childKey="result" type="object" required={true}>
      ...
      <Expandable title="result details">
        <NestedParam parentKey="activity.result" childKey="claimEarnFeesResult" type="object" required={true}>
      The claimEarnFeesResult object
...
```bash title="cURL"
curl --request POST \
  --url https://api.turnkey.com/public/v1/submit/claim_earn_fees \
...
const response = await turnkeyClient.apiClient().claimEarnFees({
  wrapperAddress: "<string> (Address of the deployed Earn wrapper to claim fees for. Must be one of the org's deployed wrappers.)"
});
```
