...
<ParamField body="parameters" type="object" required={true} path="parameters">
  ...
  <Expandable title="details">
    <NestedParam parentPath="parameters" body="userTagId" type="string" required={true} default="">
    
    Unique identifier for a given User Tag.
    </NestedParam>
    
    <NestedParam parentPath="parameters" body="newUserTagName" type="string" required={false} default="">
