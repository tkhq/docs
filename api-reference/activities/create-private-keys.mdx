  ...
  <Expandable title="details">
    <ParamField body="privateKeys" type="array" required={true} path="parameters.privateKeys">
      ...
      <Expandable title="item details">
        <NestedParam parentPath="parameters.privateKeys" body="privateKeyName" type="string" required={true} default="">
        
        Human-readable name for a Private Key.
        </NestedParam>
        
        <NestedParam parentPath="parameters.privateKeys" body="curve" type="enum<string>" required={true} default="">
        ...
        <NestedParam parentPath="parameters.privateKeys" body="addressFormats" type="enum<string[]>" required={true} default="">
...
curl --request POST \
  ...
  --data '{
    ...
    "timestampMs": "<string> (e.g., 1744995802727)",
...
```json 200
{
  "activity": {
    ...
    "timestampMs": "<timestamp> (e.g., 1744995802727)",
    "result": {
      "activity": {
        "type": "<string>",
        "intent": {
