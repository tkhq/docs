...
description: "Delete wallet accounts for a wallet."
---
...
<ParamField body="parameters" type="object" required={true} path="parameters">
  ...
  <Expandable title="details">
    <ParamField body="walletAccountIds" type="array" required={true} path="parameters.walletAccountIds">
      <p>List of unique identifiers for wallet accounts within a wallet</p>
    ...
    Optional parameter for deleting the wallet account, even if any have not been previously exported. If they have been exported, this field is ignored.
    </NestedParam>
  </Expandable>
</ParamField>
...
<NestedParam parentKey="activity" childKey="intent" type="object" required={true}>
      ...
      List of unique identifiers for wallet accounts within a wallet
...
<NestedParam parentKey="activity" childKey="result" type="object" required={true}>
      ...
      A list of unique wallet account identifiers that were removed
      <Expandable title="walletAccountIds details">
...
const response = await turnkeyClient.apiClient().deleteWalletAccounts({
  walletAccountIds: ["<string>"] // List of unique identifiers for wallet accounts within a wallet,
