      ...
      <Expandable title="item details">
        ...
        <ParamField body="oauthProviders" type="array" required={true} path="parameters.rootUsers.oauthProviders">
          ...
          <Expandable title="item details">
            ...
            <NestedParam parentKey="parameters.rootUsers.oauthProviders" childKey="oidcToken" type="string" required={false} default="">
            Base64 encoded OIDC token
            </NestedParam>
            
            <ParamField body="oidcClaims" type="object" required={false} path="parameters.rootUsers.oauthProviders.oidcClaims">
              <p>oidcClaims field</p>
              <Expandable title="details">
                <NestedParam parentKey="parameters.rootUsers.oauthProviders.oidcClaims" childKey="iss" type="string" required={true} default="">
                The issuer identifier from the OIDC token (iss claim)
                </NestedParam>
                
                <NestedParam parentKey="parameters.rootUsers.oauthProviders.oidcClaims" childKey="sub" type="string" required={true} default="">
                The subject identifier from the OIDC token (sub claim)
                </NestedParam>
                
                <NestedParam parentKey="parameters.rootUsers.oauthProviders.oidcClaims" childKey="aud" type="string" required={true} default="">
      ...
      <Expandable title="details">
        ...
        <ParamField body="accounts" type="array" required={true} path="parameters.wallet.accounts">
          ...
          <Expandable title="item details">
            ...
            <NestedParam parentKey="parameters.wallet.accounts" childKey="name" type="string" required={false} default="">
...
<NestedParam parentKey="activity" childKey="intent" type="object" required={true}>
      ...
      <Expandable title="intent details">
        <NestedParam parentKey="activity.intent" childKey="createSubOrganizationIntentV8" type="object" required={true}>
...
<NestedParam parentKey="activity" childKey="result" type="object" required={true}>
      ...
      <Expandable title="result details">
        <NestedParam parentKey="activity.result" childKey="createSubOrganizationResultV8" type="object" required={true}>
