...
<EndpointPath type="submit" path="delete_policies" />
...
<ParamField body="parameters" type="object" required={true} path="parameters">
  ...
  <Expandable title="details">
    <ParamField body="policyIds" type="array" required={true} path="parameters.policyIds">
      <p>List of unique identifiers for policies within an organization</p>
...
<NestedParam parentKey="activity" childKey="intent" type="object" required={true}>
      ...
      <Expandable title="intent details">
        <NestedParam parentKey="activity.intent" childKey="deletePoliciesIntent" type="object" required={true}>
...
<NestedParam parentKey="activity" childKey="result" type="object" required={true}>
      ...
      <Expandable title="result details">
        <NestedParam parentKey="activity.result" childKey="deletePoliciesResult" type="object" required={true}>
...
const response = await turnkeyClient.apiClient().deletePolicies({
  policyIds: ["<string>"] // List of unique identifiers for policies within an organization
});
```
