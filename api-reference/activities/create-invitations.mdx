  ...
  <Expandable title="details">
    <ParamField body="invitations" type="array" required={true} path="parameters.invitations">
      ...
      <Expandable title="item details">
        <NestedParam parentPath="parameters.invitations" body="receiverUserName" type="string" required={true} default="">
        
        The name of the intended Invitation recipient.
        </NestedParam>
        
        <NestedParam parentPath="parameters.invitations" body="receiverUserEmail" type="string" required={true} default="">
        ...
        <NestedParam parentPath="parameters.invitations" body="accessType" type="enum<string>" required={true} default="">
        
        Enum options: `ACCESS_TYPE_WEB`, `ACCESS_TYPE_API`, `ACCESS_TYPE_ALL`
        </NestedParam>
        
        <NestedParam parentPath="parameters.invitations" body="senderUserId" type="string" required={true} default="">
