...
<ParamField body="parameters" type="object" required={true} path="parameters">
  ...
  <Expandable title="details">
    <NestedParam parentPath="parameters" body="name" type="enum<string>" required={true} default="">
    ...
    <NestedParam parentPath="parameters" body="value" type="string" required={true} default="">
