...
<ParamField body="parameters" type="object" required={true} path="parameters">
  ...
  <Expandable title="details">
    ...
    <NestedParam parentKey="parameters" childKey="notes" type="string" required={true} default="">
    Notes for a Policy.
    </NestedParam>
    
    <NestedParam parentKey="parameters" childKey="time" type="string" required={false} default="">
