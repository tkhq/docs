...
<EndpointPath type="submit" path="remove_ip_allowlist" />
...
<NestedParam parentKey="activity" childKey="intent" type="object" required={true}>
      ...
      <Expandable title="intent details">
        <NestedParam parentKey="activity.intent" childKey="removeIpAllowlistIntent" type="object" required={true}>
...
<NestedParam parentKey="activity" childKey="result" type="object" required={true}>
      ...
      <Expandable title="result details">
        <NestedParam parentKey="activity.result" childKey="removeIpAllowlistResult" type="object" required={true}>
...
const response = await turnkeyClient.apiClient().removeIpAllowlist({
  publicKey: "<string> (The public component of an API key. If null, removes the organization-level IP allowlist. If set, removes the IP allowlist for this specific API key.)"
});
```
