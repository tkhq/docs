---
title: "Delete a Fiat On Ramp Credential"
...
<EndpointPath type="submit" path="delete_fiat_on_ramp_credential" />
...
<NestedParam parentKey="activity" childKey="intent" type="object" required={true}>
      ...
      <Expandable title="intent details">
        <NestedParam parentKey="activity.intent" childKey="deleteFiatOnRampCredentialIntent" type="object" required={true}>
...
<NestedParam parentKey="activity" childKey="result" type="object" required={true}>
      ...
      <Expandable title="result details">
        <NestedParam parentKey="activity.result" childKey="deleteFiatOnRampCredentialResult" type="object" required={true}>
...
const response = await turnkeyClient.apiClient().deleteFiatOnRampCredential({
  fiatOnrampCredentialId: "<string> (The ID of the fiat on-ramp credential to delete)"
});
```
