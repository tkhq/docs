...
<EndpointPath type="submit" path="delete_webhook_endpoint" />
...
<NestedParam parentKey="activity" childKey="intent" type="object" required={true}>
      ...
      <Expandable title="intent details">
        <NestedParam parentKey="activity.intent" childKey="deleteWebhookEndpointIntent" type="object" required={true}>
...
<NestedParam parentKey="activity" childKey="result" type="object" required={true}>
      ...
      <Expandable title="result details">
        <NestedParam parentKey="activity.result" childKey="deleteWebhookEndpointResult" type="object" required={true}>
...
const response = await turnkeyClient.apiClient().deleteWebhookEndpoint({
  endpointId: "<string> (Unique identifier of the webhook endpoint to delete.)"
});
```
