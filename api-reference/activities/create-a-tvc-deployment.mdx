...
<ParamField body="parameters" type="object" required={true} path="parameters">
  ...
  <Expandable title="details">
    ...
    <NestedParam
      parentKey="parameters"
      childKey="pivotContainerImageUrl"
      type="string"
      required={true}
      default=""
    >
    ...
    <ParamField
      ...
      type="array"
      required={true}
      path="parameters.pivotArgs"
    >
      <p>
        Arguments to pass to the pivot binary at startup. Encoded as a list of
        strings, for example ["--foo", "bar"]
      </p>
      <Expandable title="item details">
        <p>
          Array item type: <code>string</code>
        </p>
        <p>item field</p>
      </Expandable>
    </ParamField>
    <NestedParam
      parentKey="parameters"
      childKey="expectedPivotDigest"
      type="string"
      required={true}
      default=""
    >
      Digest of the pivot binary in the pivot container. This value will be
      inserted in the QOS manifest to ensure application integrity.
    </NestedParam>
    ...
    <NestedParam
      ...
      default=""
    >
      Optional nonce to ensure uniqueness of the deployment manifest. If not
      provided, it defaults to the current Unix timestamp in seconds.
    </NestedParam>

    <NestedParam
      parentKey="parameters"
      childKey="pivotContainerEncryptedPullSecret"
      type="string"
      required={false}
      default=""
    >
      Optional encrypted pull secret to authorize Turnkey to pull the pivot
      container image. If your image is public, leave this empty.
    </NestedParam>
    ...
    <NestedParam
      ...
      default=""
    >
      Optional flag to indicate whether to deploy the TVC app in debug mode,
      which includes additional logging and debugging tools. Default is false.
    </NestedParam>

    <NestedParam
      parentKey="parameters"
      childKey="healthCheckType"
      type="enum<string>"
      required={true}
      default=""
    >
