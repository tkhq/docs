...
<ParamField body="parameters" type="object" required={true} path="parameters">
  ...
  <Expandable title="details">
    ...
    <NestedParam parentKey="parameters" childKey="replicas" type="number" required={false} default="">
    Optional desired replica count for this deployment.
    </NestedParam>
    
    <NestedParam parentKey="parameters" childKey="instanceSizeCpus" type="number" required={false} default="">
    Optional desired instance cpu count.
    </NestedParam>
    
    <NestedParam parentKey="parameters" childKey="instanceSizeRam" type="number" required={false} default="">
...
const response = await turnkeyClient.apiClient().createTvcDeployment({
  ...
  replicas: 0 // Optional desired replica count for this deployment.,
  instanceSizeCpus: 0 // Optional desired instance cpu count.,
  instanceSizeRam: 0 // Optional desired instance memory size in GiB.
});
```
