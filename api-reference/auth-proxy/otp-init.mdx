...
<ParamField body="emailCustomization" type="object" required={false} path="emailCustomization">
  <p>emailCustomization field</p>
  <Expandable title="details">
    <NestedParam parentKey="emailCustomization" childKey="templateId" type="string" required={false} default="">
