export const EndpointFilter = ({ endpoints, tags }) => {
  ...
  const handleTagClick = (value) => {
    ...
    const isType = !!rootEl.querySelector(`[data-endpoint-type="${value}"]`);
    if (isType) {
      ...
      <div className="flex flex-col gap-4" id={filterId} data-filter-tags="" data-filter-type="all">
        <div className="flex flex-row gap-2 flex-wrap items-center">
            ...
            <span
              ...
              style={{ backgroundColor: 'rgb(var(--primary-light))', color: 'white' }}
            >
              All
            </span>
            <span
              data-endpoint-type="query"
