    ...
    <div>
      <div className="flex flex-col gap-4" id={filterId} data-filter-tags="" data-filter-type="all">
        <div className="flex flex-row gap-2 flex-wrap items-center">
            <div className="relative flex items-center px-2 bg-gray-100/50 dark:bg-primary-light rounded-full text-white dark:text-white font-medium">
              <select
                className="h-8 text-xs rounded-full bg-transparent cursor-pointer focus:outline-none appearance-none"
                defaultValue="all"
              ...
              <Icon
                ...
                color="white"
                size="12px"
                className="pointer-events-none absolute right-2 top-1/2 transform -translate-y-1/2 fill-white "
              />
            </div>
          <div className="w-px bg-zinc-200 dark:bg-white/20 h-4"></div>
