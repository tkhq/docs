...
<Note>
  To access the supported testnets, ensure that Gas Sponsorship is first enabled within your Turnkey dashboard. Then update the caip2 parameter with the corresponding chain ID.
</Note>
