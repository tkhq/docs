...
3. Once your KYB application has been approved, you will be provisioned API Keys. You can then securely upload your provisioned API Keys through turnkey's dashboard [here](https://app.turnkey.com/dashboard/wallet-kit)
