...
<p><strong>Defined in:</strong> <a href="https://github.com/tkhq/sdk/blob/v2026.2.5/packages/react-native-wallet-kit/src/providers/Types.tsx#L227">react-native-wallet-kit/src/providers/Types.tsx:227</a></p>
...
<ul>
  <li>This function initiates the OAuth 2.0 PKCE flow with Discord by opening the in-app browser and deep-linking back to the app.</li>
