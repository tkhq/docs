...
<p><strong>Defined in:</strong> <a href="https://github.com/tkhq/sdk/blob/v2026.2.5/packages/core/src/__clients__/core.ts#L1841">__clients__/core.ts:1841</a></p>
...
verification token if email or phone number is provided
    ...
    <NestedParam parentKey="params" childKey="invalidateExisting" type='boolean' required={false}></NestedParam>
