...
<p><strong>Defined in:</strong> <a href="https://github.com/tkhq/sdk/blob/v2026.3.1/packages/core/src/__clients__/core.ts#L1455">__clients__/core.ts:1455</a></p>
...
type of OTP being used (OtpType.Email or OtpType.Sms).
    ...
    <NestedParam parentKey="params" childKey="publicKey" type='string' required={false}></NestedParam>
