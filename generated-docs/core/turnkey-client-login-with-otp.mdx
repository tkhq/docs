...
<p><strong>Defined in:</strong> <a href="https://github.com/tkhq/sdk/blob/v2026.3.1/packages/core/src/__clients__/core.ts#L1339">__clients__/core.ts:1339</a></p>
...
optional organization ID to target (defaults to the verified subOrg ID linked to the verification token contact).
</NestedParam>
