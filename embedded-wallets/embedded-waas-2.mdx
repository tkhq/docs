...
No transaction executes without the end user's authentication. End users remain non-custodial because they can always [export their keys](/products/company-wallets/features/export-wallets) independently, without platform approval.
