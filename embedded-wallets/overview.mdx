...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  <SolutionCard
    ...
    description="One wallet per end user. Users authenticate with passkeys, email, or social login. No seed phrases or browser extensions."
  />
  <SolutionCard
  ...
  <SolutionCard
    ...
    description="White-labeled wallet infrastructure for platforms that resell embedded wallets to their own customers."
  />
</div>
