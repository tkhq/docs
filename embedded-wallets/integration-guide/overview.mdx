...
description:
  ...
  integrations are structured, and what the Auth Proxy is."
...
<CardGroup cols={2}>
  <Card title="React" icon="react" href="/sdks/react/index">
    Pre-built UI components, hook-based API, and no backend required. Recommended for React and
    Next.js apps.
  </Card>
  <Card title="React Native" icon="mobile" href="/sdks/react-native/overview">
    The mobile counterpart to the React wallet kit, optimized for mobile-native flows.
  </Card>
  <Card title="Flutter" icon="mobile-screen" href="/sdks/flutter">
    **Dart SDK** — Cross-platform iOS and Android support.
  </Card>
  <Card title="Swift" icon="apple" href="/sdks/swift/overview">
    **Swift SDK** — Native iOS integration.
  </Card>
  <Card title="Kotlin" icon="android" href="/sdks/kotlin/overview">
    **Kotlin SDK** — Native Android integration.
  </Card>
  <Card title="Custom / API-direct" icon="code" href="/developer-reference/api-overview/intro">
    For fully custom implementations or non-JS backends, use `@turnkey/core` or call the REST API
    directly.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Use the Auth Proxy when..." icon="check">
    <ul>
  ...
  <Card title="Use your own backend when..." icon="server">
    <ul>
