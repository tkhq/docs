...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  <FeatureCard title="Account setup" icon="rocket-01" href="/getting-started/quickstart" description="Create a Turnkey organization and generate your API keypair." />
