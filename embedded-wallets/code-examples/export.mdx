...
```bash
turnkey decrypt --export-bundle-input <path to your export bundle> --organization <your organization ID> --signer-quorum-key 04bce6666ca6c12e0e00a503a52c301319687dca588165b551d369496bd1189235bd8302ae5e001fde51d1e22baa1d44249f2de9705c63797316fc8b7e3969a665>> "<redacted mnemonic>"
```
...
```bash
turnkey decrypt --export-bundle-input <path to your export bundle> --organization <your organization ID> --signer-quorum-key 04bce6666ca6c12e0e00a503a52c301319687dca588165b551d369496bd1189235bd8302ae5e001fde51d1e22baa1d44249f2de9705c63797316fc8b7e3969a665>> "<redacted private key>"
```
...
<Frame>
   <img src="/images/embedded-wallets/code-examples/img/wallet_export_steps.png" alt="wallet export steps" />
</Frame>
...
<Frame>
   <img src="/images/embedded-wallets/code-examples/img/wallet_export_mnemonic.png" alt="wallet mnemonic" />
</Frame>
...
<Frame>
   <img src="/images/embedded-wallets/code-examples/img/private_key_export.png" alt="private key export" />
</Frame>
