...
```bash
turnkey wallets accounts export --address "<wallet account address>" --encryption-key-name <your local encryption key> --organization <your organization ID> --export-bundle-output <path to your export bundle> --host api.turnkey.com
```
