...
description: "Guide for signing and sending Ethereum transactions using Turnkey’s `signAndSendTransaction` API from `@turnkey/core`, with and without the React handler from `@turnkey/react-wallet-kit`."
---
