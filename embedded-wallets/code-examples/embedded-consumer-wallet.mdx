...
| **Key portability** | Determine whether users can import or export keys. | [Export](https://docs.turnkey.com/wallets/export-wallets), [Import](https://docs.turnkey.com/wallets/import-wallets) |
...
Turnkey authentication plugs into your onboarding flow. You can use the [Auth Proxy](/reference/auth-proxy) when you want backend-signed OTP/OAuth/signup with origin enforcement and central config without hosting your own backend; your frontend calls Auth Proxy endpoints directly. Alternatively, wire auth to your app. Get started with the [Embedded Wallets Quickstart](/getting-started/embedded-wallet-quickstart).
...
Enable key portability and define whether users can import or export private keys. Enabling export can support user sovereignty and long-term trust. See [Export](https://docs.turnkey.com/wallets/export-wallets) and [Import](https://docs.turnkey.com/wallets/import-wallets).
...
<Steps>
  ...
  <Step title="Implement Login, Signup & Session Handling">
    ...
    **Docs**
    ...
    - [Frontend authentication guide](https://docs.turnkey.com/sdks/react/auth)
  ...
  <Step title="Create a Sub-Organization & Wallet Per User">
    ...
    **Docs**
    ...
    - [Sub-organizations as wallets](https://docs.turnkey.com/generated-docs/react-wallet-kit/client-context-type-login-or-signup-with-wallet)
    - [Create wallet](https://docs.turnkey.com/generated-docs/react-wallet-kit/client-context-type-create-wallet)
    - [Create wallet accounts](https://docs.turnkey.com/generated-docs/react-wallet-kit/client-context-type-create-wallet-accounts)
  ...
  <Step title="Enable Core Wallet Actions in the UI">
    ...
    **Signing Docs**
    ...
    - [Sign message](https://docs.turnkey.com/sdks/react/signing#signing-messages)
    - [Sign transaction](https://docs.turnkey.com/generated-docs/react-wallet-kit/client-context-type-handle-sign-message)
    - [Sign & send transaction](https://docs.turnkey.com/generated-docs/react-wallet-kit/client-context-type-handle-send-transaction)

    **Import / Export / Recovery (Optional) Docs**

    - [Export wallets](https://docs.turnkey.com/wallets/export-wallets)
    - [Import wallets](https://docs.turnkey.com/wallets/import-wallets)
