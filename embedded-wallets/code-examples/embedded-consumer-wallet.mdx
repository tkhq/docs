...
| :---- | :---- | :---- |
| **Custody model** | Determine the appropriate custody model for your app. Options include user-controlled, app-controlled, or delegated/hybrid. Configure via policies and sub-organization settings. | [Delegated Access](/concepts/policies/delegated-access-frontend) |
...
Configure via [policies](/concepts/policies/quickstart) and sub-organization settings. See [Delegated Access](/concepts/policies/delegated-access-frontend) for non-custodial, hybrid, and app-controlled options.
