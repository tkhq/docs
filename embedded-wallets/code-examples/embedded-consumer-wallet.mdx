...
<Frame>
  <img src="/assets/files/Consumer%20Wallets.png" alt="Embedded Consumer Wallets architecture: user/service, wallets, policy engine, authenticators, secure enclave infrastructure" />
</Frame>
...
<Frame>
  <img src="/assets/files/moonshot_consumerwallet.png" alt="Turnkey in action: Moonshot onboarding — email sign-in, verification, portfolio, and asset view" />
</Frame>
