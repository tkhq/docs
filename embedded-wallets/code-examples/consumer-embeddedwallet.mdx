...
* **Storage:** [IndexedDB](https://developer.mozilla.org/en-US/docs/Web/API/SubtleCrypto) (web) for persistent, client-held sessions without exposing keys to your JavaScript; SecureStorage (mobile); or LocalStorage (keys in app-accessible storage).
