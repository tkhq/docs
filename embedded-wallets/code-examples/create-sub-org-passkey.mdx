...
<CardGroup cols={1}>
  <Card title="Solana Passkeys Example" href="https://github.com/tkhq/sdk/tree/main/examples/with-solana-passkeys" icon="github" iconType="solid" horizontal />
  <Card title="Ethereum Passkeys Example" href="https://github.com/tkhq/sdk/tree/main/examples/with-eth-passkeys-galore" icon="github" iconType="solid" horizontal />
  <Card title="Federated Passkeys Example" href="https://github.com/tkhq/sdk/tree/main/examples/with-federated-passkeys" icon="github" iconType="solid" horizontal />
</CardGroup>
