...
<Frame>
   <img src="/images/embedded-wallets/img/email_auth_steps.png" alt="email auth steps" />
</Frame>
...
<Frame>
   <img src="/images/embedded-wallets/img/email-auth-example-dynamic.png" alt="dynamic email auth example" />
</Frame>
