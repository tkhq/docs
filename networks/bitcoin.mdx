...
Note: for use-cases involving signing wrapped inputs like P2SH-P2WPKH or P2SH-P2WSH you can use the `SIGN_RAW_PAYLOAD` endpoint to sign pre-generated sighashes, and use a library like using a library like bitcoinjs-lib[https://github.com/bitcoinjs/bitcoinjs-lib] to handle reinsertion as per your use-case.
