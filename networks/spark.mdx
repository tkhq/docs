...
Spark addresses are derived from the `secp256k1` curve and encoded as [Bech32m](https://github.com/bitcoin/bips/blob/master/bip-0350.mediawiki) strings. Internally, the address encodes a canonical protobuf payload containing a compressed 33-byte secp256k1 public key.
