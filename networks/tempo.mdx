...
- **Raw calldata inspection**: Inspect ABI-encoded arguments in call input data using slicing (e.g. `tempo.tx.calls[0].input[34..74]`) and verify addresses with `IsGuaranteedWalletAccountInWallet`
