...
The current operators are **Lightspark** and **Flashnet**. For definitions of SE, SO, and SSP (Spark Service Provider), see [Spark core concepts](https://docs.spark.money/spark/core-concepts). For a deeper protocol walkthrough, see the [Spark technical overview](https://www.spark.money/technical-overview).
