...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  <FeatureCard title="Embedded Wallets" icon="wallet-04" href="/getting-started/embedded-wallet-quickstart" description="Build embedded wallets with Turnkey." />
  <FeatureCard title="Company Wallets" icon="server-04" href="/getting-started/company-wallets-quickstart" description="Automate signing with Turnkey." />
</div>
