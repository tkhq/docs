...
<Step title="Name your keypair">
  ...
  Optionally, you may also generate keys using the [Turnkey
  CLI](/sdks/introduction) by selecting **"Generate API key via CLI".**
</Step>
...
>
  ...
  <FeatureCard
    ...
    icon="server-04"
    href="/solutions/company-wallets/quickstart"
