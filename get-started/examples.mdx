...
| [`with-walletconnect-pay`](https://github.com/tkhq/sdk/tree/main/examples/with-walletconnect-pay) | React Native wallet that authenticates users via email OTP and signs EIP-712 payment authorizations for WalletConnect Pay |
...
<Frame>![gelato turnkey screenshot](/images/getting-started/gelato_turnkey.png)</Frame>
