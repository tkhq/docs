...
## Backing up parent organization key material

For a customer-controlled copy of wallets and private keys owned by your parent organization, see [Back up parent organization key material](/get-started/parent-organization-backup).
