...
<div className="tk-build-intro">
  ...
  <div className="tk-build-selectors">
    ...
    <div className="tk-selector-list">
      ...
      <a href="/solutions/embedded-wallets/integration-guide/overview" className="tk-selector-row" id="tk-row-b" onMouseEnter={(e) => e.currentTarget.closest('.tk-build')?.setAttribute('data-selected', 'b')} onFocus={(e) => e.currentTarget.closest('.tk-build')?.setAttribute('data-selected', 'b')}>
        <span className="tk-selector-icon" aria-hidden="true">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="/api-reference/overview/intro" className="tk-selector-row" id="tk-row-c" onMouseEnter={(e) => e.currentTarget.closest('.tk-build')?.setAttribute('data-selected', 'c')} onFocus={(e) => e.currentTarget.closest('.tk-build')?.setAttribute('data-selected', 'c')}>
        <span className="tk-selector-icon" aria-hidden="true">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div className="tk-features-section">
  ...
  <div className="tk-features-grid">
    ...
    <div className="tk-feature-column">
      ...
      <div className="tk-feature-items">
        <hr className="tk-feature-divider" />
        <a href="/features/transaction-management" className="tk-feature-row tk-feature-row--chevron">
          <span className="tk-feature-icon-circle">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
