...
<div className="tk-hero">
  ...
  <div className="tk-hero-content">
    ...
    <p className="tk-hero-body">
      Turnkey is infrastructure for generating wallets and keys, signing
      transactions, and controlling who can use them, when, and how. Private
      keys are secured in hardware-isolated enclaves and never exposed — not
      even to Turnkey.
    </p>
    <div
...
<div className="tk-build-intro">
  <div className="tk-build-copy">
    ...
    <p className="tk-build-body">
      Build at whichever level best meets your needs. Start with Solutions for
      common patterns, go deeper with our SDKs for more control, or reach all
      the way down to the API for complete flexibility. The full stack is always
      available.
    </p>
  </div>
...
<div className="tk-solution-card">
  <div className="tk-solution-thumbnail">
    <img
      src="/images/solution-embedded-wallets.png"
  ...
  <div className="tk-solution-copy">
    <a
      href="/solutions/embedded-wallets/overview"
      className="tk-solution-title"
    >
      Embedded Wallets
    </a>
    <p className="tk-solution-desc">
      Build wallets directly into your app. Users authenticate with email,
      passkeys, or social login. You control the experience.
    </p>
  </div>
...
<div className="tk-solution-card">
  <div className="tk-solution-thumbnail">
    <img
      src="/images/solution-company-wallets.png"
      alt="Company Wallets"
      noZoom
    />
  </div>
  <div className="tk-solution-copy">
    ...
    <p className="tk-solution-desc">
      Automate your onchain operations with wallets, keys and programmable
      controls purpose built for scale.
    </p>
  </div>
  <div className="tk-solution-links">
    <a
...
<div className="tk-solution-card">
  <div className="tk-solution-thumbnail">
    <img
      src="/images/solution-key-management.png"
      alt="Key Management"
      noZoom
    />
  </div>
  <div className="tk-solution-copy">
    ...
    <p className="tk-solution-desc">
      Enterprise-grade security for your most sensitive keys — hardware-backed
      with programmable access controls.
    </p>
  </div>
  <div className="tk-solution-links">
    <a
    ...
    <div className="tk-whitepaper-inner">
      ...
      <div className="tk-whitepaper-content">
        <p className="tk-whitepaper-text">
          Read our whitepaper for an in-depth look at Turnkey's security model
          and verifiable key management infrastructure.
        </p>
        <a
