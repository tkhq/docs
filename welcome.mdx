...
import { HeroIllustrationScript } from '/snippets/hero-illustration.mdx'
...
<div className="tk-hero">
  ...
  <div className="tk-hero-content">
    <h1 className="tk-hero-headline">Secure, flexible,<br/>and scalable wallet infrastructure</h1>
  ...
  <div className="tk-hero-illustration">
    <img src="/images/hero-light.svg" data-hero-inline-src="/images/hero-light.svg" className="tk-hero-img tk-img-light" alt="Turnkey hero illustration" />
    <img src="/images/hero-dark.svg" data-hero-inline-src="/images/hero-dark.svg" className="tk-hero-img tk-img-dark" alt="Turnkey hero illustration" />
    <HeroIllustrationScript />
  </div>
</div>
...
<div className="tk-build" data-selected="a">
  ...
  <div className="tk-build-intro">
    ...
    <div className="tk-build-links">
      ...
      <a href="/getting-started/quickstart" className="tk-build-link">
        <svg className="tk-build-link-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div className="tk-build-selectors">
    ...
    <div className="tk-selector-list">
      ...
      <a href="/sdks/introduction" className="tk-selector-row" id="tk-row-b" onMouseEnter={(e) => e.currentTarget.closest('.tk-build')?.setAttribute('data-selected', 'b')} onFocus={(e) => e.currentTarget.closest('.tk-build')?.setAttribute('data-selected', 'b')}>
        <span className="tk-selector-icon" aria-hidden="true">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div className="tk-whitepaper">
    <div className="tk-whitepaper-inner">
      <div className="tk-whitepaper-thumb-wrap">
        <img src="/images/whitepaper.png" className="tk-whitepaper-thumb" alt="Turnkey Whitepaper" noZoom />
      </div>
