...
title: "Using the CLI"
description:
  "This quickstart will guide you through Turnkey’s onboarding, adding an API key, creating a
  wallet, and signing your first Ethereum transaction."
sidebarTitle: "CLI"
---
...
<Frame>
  <img src="/images/sdks/img/find_org_id.png" alt="Find organization ID" />
</Frame>
...
<Frame>
  <img src="/images/sdks/img/find_user_details.png" alt="Find user details" />
</Frame>
...
[`sign_transaction` endpoint](/api-reference/signing/sign-transaction). Make sure to replace the
