...
| @turnkey/sdk-react-native             | A package to simplify integration of the Turnkey API. It provides secure session management, authentication, and cryptographic operations.                                                      | [@turnkey/sdk-react-native](https://www.npmjs.com/package/@turnkey/sdk-react-natives)                        |
