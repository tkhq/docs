---
title: "Signing"
description: "Learn how to sign messages (and optionally transactions) in your Swift app using the Turnkey Swift SDK."
...
You must be authenticated and have an active session in `TurnkeyContext`. The examples below use SwiftUI, but the SDK works with any Swift framework.
