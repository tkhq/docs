...
Create an instance of `PasskeyManager`, providing the [Relying Party Identifier](/features/authentication/passkeys/options#rp) and the [presentation anchor](<https://developer.apple.com/documentation/authenticationservices/asauthorizationcontrollerpresentationcontextproviding/presentationanchor(for:)>).
