...
- Add a URL scheme in your app that matches your app scheme (e.g., `myapp`). This is used for OAuth redirects if you enable OAuth later.
...
- For detailed passkey setup (entitlements, RP ID, UX), see the upcoming [Passkeys](/sdks/swift/authentication/passkey) guide.
