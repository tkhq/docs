...
The Turnkey Swift SDK makes authentication simple.  
You can compose your own SwiftUI screens and call focused functions for each method (Email/SMS OTP, Passkeys, or Social Logins) to build the exact experience you want [[memory:10136240]].

## Authentication state

Use the shared `TurnkeyContext` to observe authentication and react in your UI.
...
For concepts and recommended defaults, see [Sub-organizations](/concepts/sub-organizations#creating-sub-organizations).
