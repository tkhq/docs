...
<FeatureCard title="Social Logins" icon="lock-01" href="/sdks/swift/authentication/social-logins" description="Set up OAuth-based logins (Google, Apple, Discord, X)." />
