...
description: "Learn how to create and manage embedded wallets in your Swift app using the Turnkey Swift SDK."
sidebarTitle: "Using embedded wallets"
---

## Overview

The Turnkey Swift SDK provides a straightforward way to create and manage embedded wallets in your Swift application. You can create wallets, derive accounts, import/export, and refresh wallet state from `TurnkeyContext`.
