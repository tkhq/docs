...
The example below shows how to initialize and use the `WalletStamper` with the `TurnkeyClient` to make a request to Turnkey's [`/public/v1/query/whoami`](/api-reference/queries/who-am-i) endpoint:
