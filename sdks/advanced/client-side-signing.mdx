...
For an example in context, we highly recommend taking a look at the [wallet-export-sign example app](https://github.com/tkhq/sdk/blob/325fdedf2c647c9a93f28aa7355b1ff0053689f9/examples/key-management/wallet-export-sign/src/components/Export.tsx#L62-L107).
