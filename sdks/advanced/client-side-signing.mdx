...
<Note>
  Turnkey's export-and-sign iframe was recently hardened against cross-origin attacks. Clients on `@turnkey/iframe-stamper` **>= 2.1.0** are unaffected. If you are on an older version or using a custom integration, upgrade to **>= 2.1.0** (latest: 2.11.0).
</Note>
