...
For an example in context, we highly recommend taking a look at the [wallet-export-sign example app](https://github.com/tkhq/sdk/blob/0af0303ca4714cf65f5177cdb05f824877713d2a/examples/key-management/wallet-export-sign/src/components/Export.tsx#L62-L107).
