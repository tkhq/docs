...
For an example in context, we highly recommend taking a look at the [wallet-export-sign example app](https://github.com/tkhq/sdk/blob/main/examples/key-management/wallet-export-sign/src/components/Export.tsx#L62-L107).
