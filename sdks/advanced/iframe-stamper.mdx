...
### Upgrade notice: minimum version required

<Warning>
  **Effective \[date\]**

  Beginning \[date\] all customers will need to upgrade to `@turnkey/iframe-stamper` **v2.1.0** or higher to ensure no interruption to services using this package. 

  The most up-to-date version of the `@turnkey-iframe-stamper` package can always be found [here.](https://www.npmjs.com/package/@turnkey/iframe-stamper)
</Warning>
...
<ParamField body="clearClipboardOnPaste" type="boolean">
