...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  <FeatureCard title="Email & SMS" icon="lock-01" href="/sdks/kotlin/authentication/email-sms" description="Set up email and SMS authentication in your Android app." />
  <FeatureCard title="Passkey Authentication" icon="lock-01" href="/sdks/kotlin/authentication/passkey" description="Set up passkey authentication in your Android app." />
  <FeatureCard title="Social Logins" icon="lock-01" href="/sdks/kotlin/authentication/social-logins" description="Add social logins with wallet creation and account derivation in your Kotlin app." />
  <FeatureCard title="Relying party ID (rpId) setup" icon="lock-01" href="/sdks/kotlin/authentication/rp-id-setup" description="Set up the relying party ID for passkey authentication in your Android app." />
</div>