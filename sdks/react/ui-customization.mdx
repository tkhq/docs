...
The `@turnkey/react-wallet-kit` provides a set of customizable UI components that you can use to enhance the user experience in your React application. These components open up in a popup modal and can be customized to match your application's design.
...
All styles are provided in the `@turnkey/react-wallet-kit/dist/styles.css` file. You must import this file in your main application file (e.g., `app/layout.tsx` in Next.js) to ensure the styles are applied correctly.
