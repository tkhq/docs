...
You can customize the look and feel of the modals by configuring the `ui` object in the `TurnkeyProvider`'s config. This allows you to toggle light or dark mode, set custom colors, and more. You can see the full list of available options by inspecting the `TurnkeyProviderConfig` interface.
...
![Custom UI with pink primary color and dark mode](/images/sdks/img/react/auth-component-dark.png)

This applies to all UI components, not just the authentication modal.

![Custom UI with pink primary color and dark mode](/images/sdks/img/react/sign-component-dark.png)
...
![Custom modal example](/images/sdks/img/react/custom-modal.gif)
