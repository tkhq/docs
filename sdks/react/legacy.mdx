---
title: "@turnkey/sdk-react (legacy)"
sidebarTitle: "Legacy (@turnkey/sdk-react)"
---
...
This package will soon be discontinued, if you're starting a new project, we recommend using the [`@turnkey/react-wallet-kit`](/sdks/react/getting-started.mdx) instead.
