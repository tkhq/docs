...
description: "Learn how to create and manage embedded wallets in your React application using Turnkey's Embedded Wallet Kit."
...
Now that you know how to create and manage embedded wallets in your React application, check out the [External Wallet Linking](/sdks/react/external-wallet-linking) guide to learn how to link and use external wallets.
