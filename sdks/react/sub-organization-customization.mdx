...
Each authentication method can have its own set of parameters. For example, you can set a different default `userName` for `emailOtpAuth` and `passkeyAuth` methods, or specify different wallet creation options for each method.
      ...
      createSuborgParams: {
        emailOtpAuth: {
          ...
          customWallet: {
            ...
            walletAccounts: [
              // This will create one Ethereum account for users that sign up with email OTP
              {
        ...
        passkeyAuth: {
          ...
          customWallet: {
            ...
            walletAccounts: [
              // This will create one Solana account for users that sign up with passkeys
              {
                curve: "CURVE_ED25519",
                pathFormat: "PATH_FORMAT_BIP32",
                path: `m/44'/501'/0'/0'`,
