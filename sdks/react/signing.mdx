...
The `@turnkey/react-wallet-kit` provides a simple way to sign messages and transactions in your React application. You can use Turnkey's Embedded Wallets or an external wallet for signing.
