...
<CardGroup cols={2}>
  <Card title="Gas Sponsorship" icon="gas-pump" href="/company-wallets/code-examples/sending-sponsored-transactions">
    Eliminate gas costs across thousands of deposit wallets with sponsored transactions.
  </Card>
  ...
  <Card title="Smart Contract Management" icon="file-contract" href="/company-wallets/code-examples/smart-contract-management">
    Secure contract deployment, interactions, and upgrades with the same RBAC model.
  </Card>
</CardGroup>
