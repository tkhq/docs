...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px'}}>
  <FeatureCard title="Turnkey Agent Skills" icon="cpu-chip-01" href="/ai/skills" description="Embeddable guides for provisioning, managing, and monitoring agents with Turnkey." />
  ...
  <FeatureCard title="Smart Contract Interfaces" icon="file-code-02" href="/concepts/policies/smart-contract-interfaces" description="Upload ABIs for function-level policy control over agent contract interactions." />
  <SolutionCard title="Payment Orchestration" icon="payment-orchestration" href="/company-wallets/code-examples/payment-orchestration" description="Agents can automate sweep, deposit, and treasury flows with the same RBAC model." />
</div>
